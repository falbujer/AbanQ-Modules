...
/** \C 
El campo de fichero aparece inhabilitado, sólo se puede seleccionar un fichero 
mediante el botón "Seleccionar Fichero"

Al seleccionar el fichero de disco, si el mismo tiene formato DBF se convertirá 
automáticamente a CSV. Si es CSV se tomará directamente. 
...
//////////////////////////////////////////////////////////////////
//// OFICIAL /////////////////////////////////////////////////////
/** \D Abre el cuadro di diálogo para establecer el fichero de datos
...
de sistema dbf incluido en el directorio bin de la instalación de
FacturaLUX. A continuación actualiza la muestra de datos
\end */
function oficial_dbf2csv() {
  ...
  if (!File.exists(this.iface.ficheroCSV)) {
    MessageBox.warning(util.translate("scripts", "No fue posible crear el fichero\n%1\na partir del DBF.\n\nAsegúrese de que los permisos de escritura son correctos").arg(this.iface.ficheroCSV), MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
    return;
  }
  this.iface.actualizarMuestra();
}
