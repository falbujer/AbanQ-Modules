...
class oficial extends interna {
  ...
  function exportarTabla(tabla, fichero, progress) {
    return this.ctx.oficial_exportarTabla(tabla, fichero, progress);
  }
...
class ifaceCtx extends head {
  ...
  function pub_exportarTabla(tabla, fichero, progress) {
    return this.exportarTabla(tabla, fichero, progress);
  }
}
...
function oficial_exportar() {
  ...
  if (resultExport) MessageBox.information(util.translate("scripts", "Proceso finalizado"), MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
  else MessageBox.information(util.translate("scripts", "Se produjo un error. La tabla no se exportó"), MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
}
