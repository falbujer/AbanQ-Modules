...
class head extends oficial
{
  ...
  function validateForm(): Boolean {
    return this.ctx.head_validateForm();
  }
  function cambiarDirLocal_clicked()
  {
    return this.ctx.head_cambiarDirLocal_clicked();
  }
  //  function cambiarVersion_clicked() {
  //    return this.ctx.head_cambiarVersion_clicked();
  //  }
  //  function cambiarDirPeso_clicked() {
  //    return this.ctx.head_cambiarDirPeso_clicked();
  //  }
}
//// DESARROLLO /////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
function head_main()
{
  ...
  if (acpt) {
    ...
    flmaveppal.iface.pub_obtenerUrlRepositorioFun();
    flmaveppal.iface.pub_obtenerUrlRepositorioWebOficial();
    flmaveppal.iface.pub_obtenerUrlRepositorioWebFun()
  }
}
