...
// 	}
	...
	function calculaTotalLotes() {
		return this.ctx.oficial_calculaTotalLotes();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_calculaTotalLotes()
{
	var _i = this.iface;
	/** \C El número de total d procesos incluidas en la orden de producto debe ser superior a 0
	\end */
	this.child("fdbTotalLotes").setValue(_i.calculateField("totallotes"));
	return true;
}
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
