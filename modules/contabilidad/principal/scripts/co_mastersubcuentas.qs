...
class oficial extends interna {
	...
	function copiarSubcuentaEjercicio(curSubcuenta:FLSqlCursor, codigoEjercicio:String):Boolean {
		return this.ctx.oficial_copiarSubcuentaEjercicio(curSubcuenta, codigoEjercicio);
	}
...
class ifaceCtx extends head {
	...
	function pub_copiarSubcuentaEjercicio(curSubcuenta:FLSqlCursor, codigoEjercicio:String):Boolean {
		return this.copiarSubcuentaEjercicio(curSubcuenta, codigoEjercicio);
	}
}
...
function interna_init()
{
	...
	connect(this.child("toolButtonMayor"), "clicked()", _i, "libroMayor");
...
function oficial_copiarSubcuentaEjercicio(curSubcuenta:FLSqlCursor, codigoEjercicio:String):Boolean
{
	var util:FLUtil = new FLUtil();

	var codEjercicio;
	if (codigoEjercicio && codigoEjercicio != "") {
		codEjercicio = codigoEjercicio;
	} else {
		var f:Object = new FLFormSearchDB("ejercicios");
		f.setMainWidget();
		codEjercicio = f.exec("codejercicio");
		if (!codEjercicio) {
			return false;
		}
	}
