...
class interna {
	...
	function beforeCommit_co_regiva(curRegIVA:FLSqlCursor) {
		return this.ctx.interna_beforeCommit_co_regiva(curRegIVA);
	}
	function afterCommit_co_regiva(curRegiva:FLSqlCursor) {
		return this.ctx.interna_afterCommit_co_regiva(curRegiva);
	}
	function beforeCommit_co_subcuentas(curSubcuenta:FLSqlCursor) {
	...
	function afterCommit_co_asientos(curAsiento) {
		return this.ctx.interna_afterCommit_co_asientos(curAsiento);
	}
	function beforeCommit_co_partidas(curPartida:FLSqlCursor) {
		return this.ctx.interna_beforeCommit_co_partidas(curPartida);
	}
	function afterCommit_co_partidas(curPartida:FLSqlCursor) {
		return this.ctx.interna_afterCommit_co_partidas(curPartida);
	}
	function beforeCommit_co_dotaciones(curDotacion) {
		return this.ctx.interna_beforeCommit_co_dotaciones(curDotacion);
	}
	function afterCommit_co_dotaciones(curDotacion:FLSqlCursor) {
		return this.ctx.interna_afterCommit_co_dotaciones(curDotacion);
	}
	function beforeCommit_co_amortizaciones(curA) {
		return this.ctx.interna_beforeCommit_co_amortizaciones(curA);
	}
	function afterCommit_co_amortizaciones(curA) {
		return this.ctx.interna_afterCommit_co_amortizaciones(curA);
	}
}
//// INTERNA /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
class oficial extends interna {
	var PreMemorias, cacheSubcuentas_;
	...
	function formatearCodSubcta(curFormSubcuenta:Object, campoSubcuenta:String, longSubcuenta:Number,  posPuntoActual:Number) {
	...
	function datosPartidaDotacionGasto(curPartida, curDotacion, idAsiento, valoresDefecto) {
		return this.ctx.oficial_datosPartidaDotacionGasto(curPartida, curDotacion, idAsiento, valoresDefecto);
	}
	function datosPartidaDotacionAmor(curPartida, curDotacion, idAsiento, valoresDefecto) {
		return this.ctx.oficial_datosPartidaDotacionAmor(curPartida, curDotacion, idAsiento, valoresDefecto);
	}
	function clearPreMemoria() {
		return this.ctx.oficial_clearPreMemoria();
	}
	function arrayPreMemoria() {
	...
	function putLugarPreMemoria(lugarOcupado:Number, nombreMemoria:String, valorMemoria:String) {
		return this.ctx.oficial_putLugarPreMemoria(lugarOcupado, nombreMemoria, valorMemoria);
	}
	function getPreMemoria(nombreMemoria:String) {
		return this.ctx.oficial_getPreMemoria(nombreMemoria);
	}
	function lugarPreMemoria(nombreMemoria:String) {
		return this.ctx.oficial_lugarPreMemoria(nombreMemoria);
	}
	function getNombrePreMemoria(lugarOcupado:Number) {
		return this.ctx.oficial_getNombrePreMemoria(lugarOcupado);
	}
	function cantidadPreMemoria() {
		return this.ctx.oficial_cantidadPreMemoria();
	}
	function siguienteNumero(codEjercicio:String, fN:String) {
		return this.ctx.oficial_siguienteNumero(codEjercicio, fN);
	}
	function comprobarAsiento(idAsiento:String, omitirImporte:Boolean) {
		return this.ctx.oficial_comprobarAsiento(idAsiento, omitirImporte);
	}
	function informarImporteAsiento(idAsiento:String, importe:Number) {
		return this.ctx.oficial_informarImporteAsiento(idAsiento, importe);
	}
	function generarAsientoDotacion(curDotacion:FLSqlCursor) {
		return this.ctx.oficial_generarAsientoDotacion(curDotacion);
	}
	function generarPartidasDotacion(curDotacion:FLSqlCursor, idAsiento:Number, valoresDefecto:Array) {
		return this.ctx.oficial_generarPartidasDotacion(curDotacion, idAsiento, valoresDefecto);
	}
	function copiarCuenta(codCuenta:String, codEjercicioAnt:String, codEjercicio:String) {
	...
	function copiarEpigrafe(codEpigrafe:String, codEjercicioAnt:String, codEjercicio:String):String {
		return this.ctx.oficial_copiarEpigrafe(codEpigrafe, codEjercicioAnt, codEjercicio);
	}
	function controlSaldoPartida(curPartida) {
		return this.ctx.oficial_controlSaldoPartida(curPartida);
	}
	function actualizaSaldoPartidas(curPartida, idSubcuenta) {
		return this.ctx.oficial_actualizaSaldoPartidas(curPartida, idSubcuenta);
	}
	function controlSaldoAsiento(curAsiento) {
		return this.ctx.oficial_controlSaldoAsiento(curAsiento);
	}
	function fullyCalculateField(fieldName, cursor, tableName, queryName, orderBy)
  {
    return this.ctx.oficial_fullyCalculateField(fieldName, cursor, tableName, queryName, orderBy);
  }
  function subcuentasCache(codigo, tipo) {
    return this.ctx.oficial_subcuentasCache(codigo, tipo);
  }
  function controlBCAsientoCierreAmor(curA) {
    return this.ctx.oficial_controlBCAsientoCierreAmor(curA);
  }
  function controlACAsientoCierreAmor(curA) {
    return this.ctx.oficial_controlACAsientoCierreAmor(curA);
  }
  function creaAsientoCierreAmor(oParam) {
    return this.ctx.oficial_creaAsientoCierreAmor(oParam);
  }
  function generarPartidaCierreAmorEle(curA, idAsiento, valoresDefecto) {
    return this.ctx.oficial_generarPartidaCierreAmorEle(curA, idAsiento, valoresDefecto);
  }
  function generarPartidaCierreAmorAmor(curA, idAsiento, valoresDefecto) {
    return this.ctx.oficial_generarPartidaCierreAmorAmor(curA, idAsiento, valoresDefecto);
  }
  function generarPartidaCierreAmorPer(curA, idAsiento, valoresDefecto) {
    return this.ctx.oficial_generarPartidaCierreAmorPer(curA, idAsiento, valoresDefecto);
  }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
class ifaceCtx extends head {
	...
	function pub_formatearCodSubcta(curFormSubcuenta:Object, campoSubcuenta:String, longSubcuenta:Number, posPuntoActual:Number) {
		return this.formatearCodSubcta(curFormSubcuenta, campoSubcuenta, longSubcuenta, posPuntoActual);
	}
	function pub_calcularSaldo(idSubcuenta) {
		return this.calcularSaldo(idSubcuenta);
	}
	function pub_clearPreMemoria() {
		return this.clearPreMemoria();
	}
	function pub_arrayPreMemoria() {
	...
	function pub_putLugarPreMemoria(lugarOcupado:Number, nombreMemoria:String, valorMemoria:String) {
		return this.putLugarPreMemoria(lugarOcupado, nombreMemoria, valorMemoria);
	}
	function pub_getPreMemoria(nombreMemoria:String) {
		return this.getPreMemoria(nombreMemoria);
	}
	function pub_lugarPreMemoria(nombreMemoria:String) {
		return this.lugarPreMemoria(nombreMemoria);
	}
	function pub_getNombrePreMemoria(lugarOcupado:Number) {
		return this.getNombrePreMemoria(lugarOcupado);
	}
	function pub_cantidadPreMemoria() {
		return this.cantidadPreMemoria();
	}
	function pub_comprobarAsiento(idAsiento:String, omitirImporte:Boolean) {
		return this.comprobarAsiento(idAsiento, omitirImporte);
	}
	function pub_copiarCuenta(codCuenta:String, codEjercicioAnt:String, codEjercicio:String) {
		return this.copiarCuenta(codCuenta, codEjercicioAnt, codEjercicio);
	}
	function pub_actualizaSaldoPartidas(curPartida, oDatos) {
		return this.actualizaSaldoPartidas(curPartida, oDatos);
	}
}
...
function interna_init()
{
	...
	var util= new FLUtil();
	var cursor= new FLSqlCursor("co_codbalances");
	cursor.select();
	if (!cursor.first()) {
		this.iface.valoresIniciales();
		this.iface.comprobarEjercicios();
		if (util.sqlSelect("empresa", "contintegrada", "1 = 1") == false) {
			var res= MessageBox.information(sys.translate("¿Desea activar la integración entre facturación y contabilidad?"), MessageBox.Yes, MessageBox.No, MessageBox.NoButton);
...
function interna_beforeCommit_co_regiva(curRegIVA)
{
...
\end */
		...
		if (curRegIVA.modeAccess() == curRegIVA.Insert
				...
				var codEjercicio= util.sqlSelect("co_asientos", "codejercicio",
						"idasiento = " + curRegIVA.valueBuffer("idasiento"));
				var qryEjercicio= new FLSqlQuery();
				...
				var iniRegIVA= new Date(Date.parse(curRegIVA.valueBuffer("fechainicio").toString()));
				var finRegIVA= new Date(Date.parse(curRegIVA.valueBuffer("fechafin").toString()));
				...
				if (util.sqlSelect("co_regiva", "idregiva",
						...
						sys.warnMsgBox(sys.translate("La fecha de inicio del período se superpone a un período ya existente"));
						return false;
				}
				if (util.sqlSelect("co_regiva", "idregiva",
						"fechainicio <= '" + finRegIVA + "' AND fechafin >= '" + iniRegIVA + "'"  +
						" AND idregiva <> " + curRegIVA.valueBuffer("idregiva"))) {
						sys.warnMsgBox(sys.translate("La fecha de fin del período se superpone a un período ya existente"));
						return false;
				}
		}
...
\end */
function interna_beforeCommit_co_subcuentas(curSubcuenta)
{
		var util= new FLUtil();
		...
		case curSubcuenta.Insert:
				if (!curSubcuenta.valueBuffer("codsubcuenta").startsWith(curSubcuenta.valueBuffer("codcuenta").toString().left(3))) {
						sys.warnMsgBox(sys.translate("El código de subcuenta debe tener como prefijo el código de la cuenta de la que depende:") + curSubcuenta.valueBuffer("codcuenta"));
						return false;
				}
		}
		return true;
...
function interna_beforeCommit_co_asientos(curAsiento)
{
	var util= new FLUtil();
	...
	switch(curAsiento.modeAccess()) {
		case curAsiento.Edit: {
			if (!util.sqlSelect("ejercicios", "codejercicio", "fechainicio <= '" + curAsiento.valueBufferCopy("fecha") + "'" +  " AND fechafin >= '" + curAsiento.valueBufferCopy("fecha") + "'" +  " AND estado = 'ABIERTO'")) {
				sys.warnMsgBox(sys.translate("Sólo pueden modificarse los asientos que pertenecen a un ejercicio abierto"));
				return false;
			}
		}
		case curAsiento.Del:
		case curAsiento.Insert: {
			if (!util.sqlSelect("ejercicios", "codejercicio", "codejercicio = '" + curAsiento.valueBuffer("codejercicio") + "'" +  " AND fechainicio <= '" + curAsiento.valueBuffer("fecha") + "'" + " AND fechafin >= '" + curAsiento.valueBuffer("fecha") + "'" + " AND estado = 'ABIERTO'")) {
				sys.warnMsgBox(sys.translate("El asiento contable no pertenece al período del ejercicio asignado, o el ejercicio no está abierto"));
				return false;
			}
			if (curAsiento.modeAccess() == curAsiento.Insert || curAsiento.modeAccess() == curAsiento.Edit) {
				if (util.sqlSelect("co_asientos", "numero", "codejercicio = '" + curAsiento.valueBuffer("codejercicio") + "' AND numero = '" + curAsiento.valueBuffer("numero") + "' AND idasiento <> " + curAsiento.valueBuffer("idasiento"))) {
					//MessageBox.information(sys.translate("Ya existe un asiento con el número y ejercicio especificados.\nEl número de asiento volverá a calcularse."), MessageBox.Ok, MessageBox.NoButton);
	...
	switch(curAsiento.modeAccess()) {
		...
		case curAsiento.Edit: {
			var concepto= curAsiento.valueBuffer("concepto");
			if (concepto && concepto != "") {
				if (concepto.length > 255) {
					concepto = concepto.left(252) + "...";
					curAsiento.setValueBuffer("concepto", concepto);
				}
			}
		}
	}
...
\end \end */
function interna_beforeCommit_co_partidas(curPartida)
{
	var idSubcuenta= curPartida.valueBuffer("idsubcuenta");
	var idSubcuentaPrevia= curPartida.valueBufferCopy("idsubcuenta");
	var idAsiento= curPartida.valueBuffer("idasiento");
	...
	switch (curPartida.modeAccess()) {
		case curPartida.Insert:
		case curPartida.Edit: {
			var concepto= curPartida.valueBuffer("concepto");
			if (concepto && concepto != "") {
				if (concepto.length > 255) {
					concepto = concepto.left(252) + "...";
...
\end */
function interna_afterCommit_co_partidas(curPartida)
{
	var _i = this.iface;
	var util= new FLUtil();
	...
	if (!_i.controlSaldoPartida(curPartida)) {
		return false;
	}
	return true;
...
\end */
function interna_afterCommit_co_regiva(curRegiva)
{
	var util= new FLUtil;
...
function interna_beforeCommit_co_dotaciones(curDotacion:FLSqlCursor)
{
...
function interna_afterCommit_co_dotaciones(curDotacion:FLSqlCursor)
{
	switch (curDotacion.modeAccess()) {
		...
		case curDotacion.Edit: {
			if (curDotacion.valueBuffer("nogenerarasiento")) {
				var idAsientoAnterior= curDotacion.valueBufferCopy("idasiento");
...
function interna_beforeCommit_co_amortizaciones(curA)
{
	var _i = this.iface;
	if (!_i.controlBCAsientoCierreAmor(curA)) {
		return false;
	}
	return true;
}

function interna_afterCommit_co_amortizaciones(curA)
{
	var _i = this.iface;

	if (!_i.controlACAsientoCierreAmor(curA)) {
		return false;
	}
	return true;
}

function interna_afterCommit_co_asientos(curAsiento)
{
	var _i = this.iface;
	if (!_i.controlSaldoAsiento(curAsiento)) {
		return false;
	}
	return true;
}
...
function oficial_valoresIniciales()
{
		...
		var cursor= new FLSqlCursor("co_cuentasesp");
...
function oficial_comprobarEjercicios()
{
		...
		var res;
		if (q.next()) {
				res = MessageBox.information(sys.translate("El ejercicio actual: ") +
						q.value(0) + "-" + q.value(1) +
						sys.translate(" no tiene Plan General Contable asociado\n¿desea crearlo ahora?"),
...
function oficial_generarPGC(codEjercicio)
{
		...
		var numCuentasEsp= this.iface.valorPorClave("co_cuentasesp", "count(idcuentaesp)", "1 = 1");
		if (numCuentasEsp == 0) this.iface.valoresIniciales();

		var curEpi= new FLSqlCursor("co_epigrafes");
		var curCue= new FLSqlCursor("co_cuentas");
		...
		var idEpigrafeIni= util.sqlSelect("co_epigrafes", "MAX(idepigrafe)","idepigrafe <> 0");
		var idCuentaIni= util.sqlSelect("co_cuentas", "MAX(idcuenta)","idcuenta <> 0");
		...
		var idPadre= 0;
		var idCuenta= 0;
		util.createProgressDialog(sys.translate("Creando Plan General Contable"),
				datos.length);
		var j= 0;
		util.setProgress(0);
		for (i = 0; i < datos.length; i++) {
...
function oficial_generarCodigosBalance()
{
		...
		var curCbl= new FLSqlCursor("co_codbalances");
...
function oficial_generarSubcuentas(codEjercicio, longSubcuenta)
{
		var util= new FLUtil();
		var i,j:Number;
		var numCuentas= this.iface.valorPorClave("co_cuentas", "count(codcuenta)", "codejercicio = '" + codEjercicio + "'");

		var cont1= 0
		var cont2= 0;
		util.createProgressDialog(sys.translate("Generando Subcuentas"), numCuentas);
		util.setProgress(0);

		var curCuenta= new FLSqlCursor("co_cuentas");
		...
		while (curCuenta.next()) {
				...
				var auxCSC= codSubcuenta.toString();
...
\end */
function oficial_comprobarRegIVA(idSubcuenta, idAsiento)
{
	var util= new FLUtil();
	...
	var idCuentaEsp= util.sqlSelect("co_subcuentas s INNER JOIN co_cuentas c ON s.idcuenta = c.idcuenta", "c.idcuentaesp", "s.idsubcuenta = " + idSubcuenta, "co_subcuentas,co_cuentas");
	if (idCuentaEsp == "IVAREP" || idCuentaEsp == "IVASOP") {
		var fechaAsiento= util.sqlSelect("co_asientos", "fecha", "idasiento = " + idAsiento);
		var ejercicioAsiento= util.sqlSelect("co_asientos", "codejercicio", "idasiento = " + idAsiento);
		if (util.sqlSelect("co_regiva", "idregiva", "fechainicio <= '" + fechaAsiento + "' AND fechafin >= '" + fechaAsiento + "' and codejercicio = '" + ejercicioAsiento + "'")) {
			sys.warnMsgBox(sys.translate("No puede modificarse una partida de I.V.A. en un período ya regularizado"));
			return false;
		}
	}
	return true;
...
\end */
function oficial_calcularSaldo(idSubcuenta)
{
	var util= new FLUtil;
...
\end */
function oficial_formatearCodSubcta(curFormSubcuenta:Object, campoSubcuenta:String, longSubcuenta:Number, posPuntoActual:Number)
{
	var util= new FLUtil();
	var cursor= curFormSubcuenta.cursor();
	var cambiado= false;
	var valCodSubcta= curFormSubcuenta.child(campoSubcuenta).value().toString();
	var lenValCodSubcta= valCodSubcta.length;
	var nuevoPunto= valCodSubcta.find(".");
	...
	if (nuevoPunto > -1) {
		...
		var strCeros = "";
		for (var i = 0; i < numCeros; i++) {
			strCeros = strCeros == "" ? "0" : (strCeros + "0");
		}
...
function oficial_rellenarSubcuentas()
{
	...
	if (!util.sqlSelect("co_subcuentascli", "id", "1 = 1")) {
		...
		if (!qryClientes.exec())
			return;
		util.createProgressDialog(sys.translate("Creando subcuentas por cliente"), qryClientes.size());
		util.setProgress(0);
	...
	if (!util.sqlSelect("co_subcuentasprov", "id", "1 = 1")) {
		var qryProveedores= new FLSqlQuery();
		...
		if (!qryProveedores.exec())
			return;
		util.createProgressDialog(sys.translate("Creando subcuentas por proveedor"), qryProveedores.size());
		util.setProgress(0);
...
\end */
function oficial_arrayPreMemoria() {
...
{
	var lugarOcupado= this.iface.lugarPreMemoria(nombreMemoria);
	if (lugarOcupado == -1) {
...
\end */
function oficial_putLugarPreMemoria(lugarOcupado:Number, nombreMemoria:String, valorMemoria:String)
{
...
\end */
function oficial_getPreMemoria(nombreMemoria:String)
{
	var lugarOcupado= this.iface.lugarPreMemoria(nombreMemoria);
	var res= "";
	if (lugarOcupado != -1) {
...
\end */
function oficial_lugarPreMemoria(nombreMemoria:String)
{
	var _i = this.iface;
	if (!_i.PreMemorias) {
		_i.PreMemorias = new Array(0);
	}
	var contador= _i.PreMemorias.length;
	var res= -1;
	for (var i= 0; i < contador; i+=2)
		if (_i.PreMemorias[i] == nombreMemoria)
			res = i;
	return res;
}
...
@return	valor almacenado
\end */
function oficial_getNombrePreMemoria(lugarOcupado:Number)
{
	var res= "";
	if (lugarOcupado >= 0 && lugarOcupado < this.iface.PreMemorias.length) {
...
\end */
function oficial_cantidadPreMemoria()
{
	var total= this.iface.PreMemorias.length;
	return total;
}
...
\end */
function oficial_siguienteNumero(codEjercicio:String, fN:String)
{
	var numero:Number;
	...
	var util= new FLUtil;
	var cursorSecuencias= new FLSqlCursor("co_secuencias");
	...
	if (cursorSecuencias.next()) {
		...
		sys.addDatabase("Aux");
		var curAux= new FLSqlCursor("co_secuencias", "Aux");
...
\end */
function oficial_comprobarAsiento(idAsiento:String, omitirImporte:Boolean)
{
	var util= new FLUtil;

	var totalDebe= 0;
	var totalHaber= 0;
	var lista= sys.translate("\nSubcuenta\tDebe\Haber\t");
	...
	while (qryPartidas.next()) {
		...
		if (debe != util.roundFieldValue(debe, "co_partidas", "debe") || haber != util.roundFieldValue(haber, "co_partidas", "haber")) {
			sys.errorMsgBox(sys.translate("Error de redondeo:\nSubcuenta\tDebe\Haber \n%2\n%3\n%4").arg(qryPartidas.value("codsubcuenta")).arg(debe).arg(haber));
			return false;
		}
	...
	if (totalDebe != totalHaber) {
		sys.errorMsgBox(sys.translate("Ha habido un error al generar el asiento:\nEl asiento no cuadra:%1").arg(lista));
		return false;
	}
	...
	if (util.sqlSelect("co_partidas p inner join co_asientos a on p.idasiento = a.idasiento inner join co_subcuentas s on p.idsubcuenta = s.idsubcuenta", "a.idasiento", "a.idasiento = " + idAsiento + " AND a.codejercicio <> s.codejercicio", "co_asientos,co_partidas,co_subcuentas")) {
		sys.errorMsgBox(sys.translate("Ha habido un error al generar el asiento:\nEl ejercicio de las distintas subcuentas no coincide.\n Asegúrese de estar en el ejercicio correcto y vuelva a generar el asiento."));
		return false;
	}
...
function oficial_informarImporteAsiento(idAsiento:String, importe:Number)
{
	var curAsiento= new FLSqlCursor("co_asientos");
	...
	var editable= curAsiento.valueBuffer("editable");
	if (!editable) {
		curAsiento.setUnLock("editable", true);
		curAsiento.select("idasiento = " + idAsiento);
		if (!curAsiento.first()) {
...
function oficial_generarAsientoDotacion(curDotacion:FLSqlCursor)
{
	...
	var fecha= curDotacion.valueBuffer("fecha");

	var idAsiento= curDotacion.valueBuffer("idasiento");
	var ejercicio= "";
	if (idAsiento) {
...
function oficial_generarPartidasDotacion(curDotacion, idAsiento, valoresDefecto)
{
	var _i = this.iface;
	var util= new FLUtil();
	...
	var codDivisa= valoresDefecto["coddivisa"];
	var tasaConv= parseFloat(util.sqlSelect("divisas","tasaconv","coddivisa = '" + codDivisa + "'"));

	var importe= curDotacion.valueBuffer("importe");
	var importeME= importe * tasaConv;
	importe = util.roundFieldValue(importe, "co_partidas", "haber");
	importeME = util.roundFieldValue(importeME, "co_partidas", "haberme");

	var codAmortizacion = curDotacion.valueBuffer("codamortizacion");

	var codSubcuentaGasto = AQUtil.sqlSelect("co_amortizaciones a INNER JOIN co_gruposcontablesamo g ON a.codgrupocontableamo = g.codgrupo", "g.codsubcuentagas", "codamortizacion = '" + codAmortizacion + "'", "co_amortizaciones");
	if (!codSubcuentaGasto) {
		sys.warnMsgBox(sys.translate("No tiene definida una subcuenta de gasto para el grupo de amortización asociado al activo %1").arg(codAmortizacion));
		return false;
	}
	var idSubcuentaGasto = AQUtil.sqlSelect("co_subcuentas", "idsubcuenta", "codsubcuenta = '" + codSubcuentaGasto + "' AND codejercicio = '" + codEjercicio + "'");
	if (!idSubcuentaGasto) {
		sys.warnMsgBox(sys.translate("No existe la subcuenta %1 para el ejercicio %2.\nAntes de crear la dotación para esta fecha debe crear la subcuenta").arg(codSubcuentaGasto).arg(codEjercicio));
		return false;
	}
	var concepto = sys.translate("scripts", "Dotación de %1 - %2").arg(AQUtil.sqlSelect("co_amortizaciones","elemento","codamortizacion = '" + codAmortizacion + "'")).arg(AQUtil.dateAMDtoDMA(fecha));

	var curPartida= new FLSqlCursor("co_partidas");
	with (curPartida) {
		setModeAccess(curPartida.Insert);
		refreshBuffer();
		setValueBuffer("idsubcuenta", idSubcuentaGasto);
		setValueBuffer("codsubcuenta", codSubcuentaGasto);
		...
		setValueBuffer("codactivo", codAmortizacion);
	}
	if (!_i.datosPartidaDotacionGasto(curPartida, curDotacion, idAsiento, valoresDefecto)) {
		return false;
	}
	...
	var codSubcuentaAmo = AQUtil.sqlSelect("co_amortizaciones a INNER JOIN co_gruposcontablesamo g ON a.codgrupocontableamo = g.codgrupo", "g.codsubcuentaamo", "codamortizacion = '" + codAmortizacion + "'", "co_amortizaciones");
	if (!codSubcuentaGasto) {
		sys.warnMsgBox(sys.translate("No tiene definida una subcuenta de amortización acumulada para el grupo de amortización asociado al activo %1").arg(codAmortizacion));
		return false;
	}
	var idSubcuentaAmo = AQUtil.sqlSelect("co_subcuentas", "idsubcuenta", "codsubcuenta = '" + codSubcuentaAmo + "' AND codejercicio = '" + codEjercicio + "'");
	if (!idSubcuentaAmo) {
		sys.warnMsgBox(sys.translate("No existe la subcuenta %1 para el ejercicio %2.\nAntes de crear la dotación para esta fecha debe crear la subcuenta").arg(codSubcuentaAmo).arg(codEjercicio));
		return false;
	}
	...
	with (curPartida) {
		setModeAccess(curPartida.Insert);
		refreshBuffer();
		setValueBuffer("idsubcuenta", idSubcuentaAmo);
		setValueBuffer("codsubcuenta",codSubcuentaAmo);
		setValueBuffer("idasiento", idAsiento);
	...
	if (!_i.datosPartidaDotacionAmor(curPartida, curDotacion, idAsiento, valoresDefecto)) {
		return false;
	}
...
function oficial_datosPartidaDotacionGasto(curPartida, curDotacion, idAsiento, valoresDefecto)
{
	return true;
}
function oficial_datosPartidaDotacionAmor(curPartida, curDotacion, idAsiento, valoresDefecto)
{
	return true;
}
...
function oficial_rellenarCuentaEsp()
{
	...
	var total= qryCuentas.size();
	var paso= 0;
	util.createProgressDialog(sys.translate("Actualizando cuentas especiales (1/2)..."), total);
...
debug("codcuenta " + qryCuentas.value("codcuenta"))
	...
	var qryCuentasEsp= new FLSqlQuery;
	with (qryCuentasEsp) {
	...
	paso = 0;
	util.createProgressDialog(sys.translate("Actualizando cuentas especiales (2/2)..."), total);
	var idCuentaEsp:String;
	var codSubcuenta:String;
...
function oficial_copiarCuenta(codCuenta:String, codEjercicioAnt:String, codEjercicio:String)
{
	var util= new FLUtil();
	var curCuentaOrigen= new FLSqlCursor("co_cuentas");
	...
	var codEpigrafe= curCuentaOrigen.valueBuffer("codepigrafe");
	var idEpigrafe= util.sqlSelect("co_epigrafes", "idepigrafe", "codepigrafe = '" + codEpigrafe + "' AND codejercicio = '" + codEjercicio + "'");
	if (!idEpigrafe) {
		idEpigrafe = this.iface.copiarEpigrafe(codEpigrafe, codEjercicioAnt, codEjercicio);
		if (!idEpigrafe) {
			sys.warnMsgBox(sys.translate("Hubo un error al copiar el epígrafe %1 al ejercicio %2.").arg(codEpigrafe).arg(codEjercicio));
			return false;
		}

// 		MessageBox.warning(sys.translate("El epígrafe %1 no existe en el ejercicio %2.").arg(codEpigrafe).arg(codEjercicio), MessageBox.Ok, MessageBox.NoButton);
// 		return false;
	}
	...
	var idCuenta= curCuenta.valueBuffer("idcuenta");
	return idCuenta;
}

function oficial_copiarEpigrafe(codEpigrafe:String, codEjercicioAnt:String, codEjercicio:String):String
{
...
function oficial_controlSaldoAsiento(curAsiento)
{
	return true; /// Esperar a Fede
	var _i = this.iface;
	switch (curAsiento.modeAccess()) {
		case curAsiento.Edit: {
			if ((curAsiento.valueBuffer("fecha") != curAsiento.valueBufferCopy("fecha")) || (curAsiento.valueBuffer("numero") != curAsiento.valueBufferCopy("numero"))) {
				var fechaDesde, numDesde;
				var d = AQUtil.daysTo(curAsiento.valueBuffer("fecha"), curAsiento.valueBufferCopy("fecha"));
				if (d > 0) {
					fechaDesde = curAsiento.valueBuffer("fecha");
					numDesde = curAsiento.valueBuffer("numero");
				} else if (d < 0) {
					fechaDesde = curAsiento.valueBufferCopy("fecha");
					numDesde = curAsiento.valueBufferCopy("numero");
				} else {
					if (parseFloat(curAsiento.valueBuffer("numero")) < parseFloat(curAsiento.valueBufferCopy("numero"))) {
						fechaDesde = curAsiento.valueBuffer("fecha");
						numDesde = curAsiento.valueBuffer("numero");
					} else {
						fechaDesde = curAsiento.valueBufferCopy("fecha");
				...
				q.setFrom("co_partidas");
				q.setWhere("idasiento = " + curAsiento.valueBuffer("idasiento"));
				...
				oDatos.numDesde = numDesde;
				while (q.next()) {
					oDatos.idSubcuenta = q.value("idsubcuenta");
					if (!_i.actualizaSaldoPartidas(false, oDatos)) {
						return false;
					}
				}
			}
...
function oficial_controlSaldoPartida(curPartida)
{
	return true; /// Esperar a Fede
	...
	switch (curPartida.modeAccess()) {
		case curPartida.Insert:
			case curPartida.Del: {
			if (!_i.actualizaSaldoPartidas(curPartida)) {
				return false;
			}
			break;
		}
		case curPartida.Edit: {
			if (curPartida.valueBuffer("idsubcuenta") != curPartida.valueBufferCopy("idsubcuenta")) {
				var oDatos = new Object;
				oDatos.idSubcuenta = curPartida.valueBufferCopy("idsubcuenta");
				if (!_i.actualizaSaldoPartidas(curPartida, oDatos)) {
					return false;
				}
				if (!_i.actualizaSaldoPartidas(curPartida)) {
					return false;
				}
			} else if ((curPartida.valueBuffer("debe") != curPartida.valueBufferCopy("debe") || (curPartida.valueBuffer("haber") != curPartida.valueBufferCopy("haber")))) {
				if (!_i.actualizaSaldoPartidas(curPartida)) {
					return false;
				}
			}
...
/** \D
oDatos.idSubcuenta: Subcuenta cuyo saldo calcular
oDatos.fechaDesde: Fecha a partir de la cual calcular el saldo
oDatos.numDesde: Número a partir del cual calcular el saldo
*/
function oficial_actualizaSaldoPartidas(curPartida, oDatos)
{
	return true; /// Esperar a Fede
	var _i = this.iface;
	debug("oDatos " + oDatos);
	var idSubcuenta = (oDatos && "idSubcuenta" in oDatos) ? oDatos.idSubcuenta : curPartida.valueBuffer("idsubcuenta");
	var fechaDesde, numDesde;
	if (oDatos && "fechaDesde" in oDatos) {
		fechaDesde = oDatos.fechaDesde;
		numDesde = oDatos.numDesde;
	} else {
		var idAsiento = curPartida.valueBuffer("idasiento");
	...
	var curPartidasMayor = new FLSqlCursor("co_partidasmayor");
	curPartidasMayor.setActivatedCheckIntegrity(false);
	curPartidasMayor.setActivatedCommitActions(false);

	var saldo = 0;
	curPartidasMayor.select("co_partidas.idsubcuenta = " + idSubcuenta + " AND (co_asientos.fecha < '" + fechaDesde + "' OR (co_asientos.fecha = '" + fechaDesde + "' AND co_asientos.numero < " + numDesde + ")) ORDER by co_asientos.fecha DESC, co_asientos.numero DESC");
	if (curPartidasMayor.first()) {
		curPartidasMayor.setModeAccess(curPartidasMayor.Browse);
		curPartidasMayor.refreshBuffer();
		saldo = parseFloat(curPartidasMayor.valueBuffer("saldo"));
	}
	curPartidasMayor.select("co_partidas.idsubcuenta = " + idSubcuenta + " AND (co_asientos.fecha > '" + fechaDesde + "' OR (co_asientos.fecha = '" + fechaDesde + "' AND co_asientos.numero >= " + numDesde + ")) ORDER by co_asientos.fecha, co_asientos.numero");
	while (curPartidasMayor.next()) {
		curPartidasMayor.setModeAccess(curPartidasMayor.Edit);
		curPartidasMayor.refreshBuffer();
		saldo += parseFloat(curPartidasMayor.valueBuffer("debe"));
		saldo -= parseFloat(curPartidasMayor.valueBuffer("haber"));
		curPartidasMayor.setValueBuffer("saldo", saldo);
		if (!curPartidasMayor.commitBuffer()) {
			return false;
		}
	}
	return true;
...
function oficial_fullyCalculateField(fieldName, cursor, tableName, queryName, orderBy)
{
	var _i = this.iface;
		...
		case "co_partidasmayor": {
			switch (fieldName) {
				case "saldo": {
					...
					var idSubcuenta = cursor.value("idsubcuenta");
					...
					qry.setWhere("idsubcuenta = " + idSubcuenta);
...
function oficial_subcuentasCache(codigo, tipo)
{
// debug("euromoda_subcuentasCache");
	var _i = this.iface;
	if (_i.cacheSubcuentas_) {
		if (_i.cacheSubcuentas_["tipo"] == tipo && _i.cacheSubcuentas_["codigo"] == codigo) {
// debug("euromoda_subcuentasCache: " + codigo + " En cache");
			return _i.cacheSubcuentas_["subcuentas"];
		}
	}
	_i.cacheSubcuentas_ = new Object;
	_i.cacheSubcuentas_["codigo"] = codigo;
	_i.cacheSubcuentas_["tipo"] = tipo;
	_i.cacheSubcuentas_["subcuentas"] = "'not found'";
	switch (tipo) {
// 		case "cliente": {
// 			var codGrupo = AQUtil.sqlSelect("clientes", "codgrupocontablecli", "codcliente = '" + codigo + "'");
// 			_i.cacheSubcuentas_["subcuentas"] = formRecordclientes.iface.pub_dameListaSubcuentas(codGrupo);
// 			break;
// 		}
// 		case "proveedor": {
// 			var codGrupo = AQUtil.sqlSelect("proveedores", "codgrupocontableprov", "codproveedor = '" + codigo + "'");
// 			_i.cacheSubcuentas_["subcuentas"] = formRecordproveedores.iface.pub_dameListaSubcuentas(codGrupo);
// 			break;
// 		}
		case "activo": {
			var codGrupo = AQUtil.sqlSelect("co_amortizaciones", "codgrupocontableamo", "codamortizacion = '" + codigo + "'");
			_i.cacheSubcuentas_["subcuentas"] = formRecordco_amortizaciones.iface.pub_dameListaSubcuentas(codGrupo);
		}
	}
	return _i.cacheSubcuentas_["subcuentas"];
}

function oficial_controlBCAsientoCierreAmor(curA)
{
	var _i = this.iface;
	...
	if (curA.valueBuffer("nogenerarasientocierre")) {
		curA.setNull("idasientocierre");
		return true;
	}
	if (curA.valueBuffer("estado") != "Cerrada") {
		return true;
	}

	var codAmortizacion = curA.valueBuffer("codamortizacion");

	var oParam = new Object;
	oParam.errorMsg = sys.translate("Error al crear el asiento de cierre de la amortización %1").arg(codAmortizacion);
	oParam.cursor = curA;

	var f = new Function("oParam", "return _i.creaAsientoCierreAmor(oParam)");
...
function oficial_creaAsientoCierreAmor(oParam)
{
	var _i = this.iface;
	var curA = oParam.cursor;
	...
	var datosAsiento = [];
	var valoresDefecto = [];
	var fecha= curA.valueBuffer("fechacierre");

	var idAsiento = curA.valueBuffer("idasientocierre");
	var ejercicio = "";
	if (idAsiento) {
		ejercicio = AQUtil.sqlSelect("co_asientos", "codejercicio", "idasiento = " + idAsiento);
	} else {
		ejercicio = flfactppal.iface.pub_ejercicioActual();
	}
debug("ejercicio = " + ejercicio);
debug("curA = " + curA.valueBuffer("fechacierre"));
	valoresDefecto["codejercicio"] = ejercicio;
	valoresDefecto["coddivisa"] = flfactppal.iface.pub_valorDefectoEmpresa("coddivisa");
	valoresDefecto["campoasiento"] = "idasientocierre";
	valoresDefecto["campofecha"] = "fechacierre";

	datosAsiento = flfacturac.iface.pub_regenerarAsiento(curA, valoresDefecto);
	if (datosAsiento.error == true) {
		oParam.errorMsg = sys.translate("Error al regenerar el asiento de cierre de la amortización %1").arg(codAmortizacion);
		return false;
	}

	valoresDefecto["concepto"] = sys.translate("Cierre amortización activo %1 - %2").arg(codAmortizacion).arg(curA.valueBuffer("elemento"));

	if (!_i.generarPartidaCierreAmorEle(curA, datosAsiento.idasiento, valoresDefecto)) {
		oParam.errorMsg = sys.translate("Error al la partida de elemento en el asiento de cierre de la amortización %1").arg(codAmortizacion);
		return false;
	}
	if (!_i.generarPartidaCierreAmorAmor(curA, datosAsiento.idasiento, valoresDefecto)) {
		oParam.errorMsg = sys.translate("Error al la partida de amortización acumulada en el asiento de cierre de la amortización %1").arg(codAmortizacion);
		return false;
	}
	if (!_i.generarPartidaCierreAmorPer(curA, datosAsiento.idasiento, valoresDefecto)) {
		oParam.errorMsg = sys.translate("Error al la partida de pérdidas en el asiento de cierre de la amortización %1").arg(codAmortizacion);
		return false;
	}

	curA.setValueBuffer("idasientocierre", datosAsiento.idasiento);

	if (!flcontppal.iface.pub_comprobarAsiento(datosAsiento.idasiento)) {
		oParam.errorMsg = sys.translate("Error al comprobar el asiento de cierre de la amortización %1").arg(codAmortizacion);
		return false;
	}
	return true;
}

function oficial_generarPartidaCierreAmorEle(curA, idAsiento, valoresDefecto)
{
	var _i = this.iface;
	var util= new FLUtil();
	...
	var codEjercicio = valoresDefecto["codejercicio"];
	var codDivisa = valoresDefecto["coddivisa"];
	var tasaConv= parseFloat(AQUtil.sqlSelect("divisas", "tasaconv", "coddivisa = '" + codDivisa + "'"));

	var importe = curA.valueBuffer("valoramortizable");
	var importeME = importe * tasaConv;
	importe = AQUtil.roundFieldValue(importe, "co_partidas", "haber");
	importeME = AQUtil.roundFieldValue(importeME, "co_partidas", "haberme");

	var codAmortizacion = curA.valueBuffer("codamortizacion");

	var codSubcuentaEle = AQUtil.sqlSelect("co_amortizaciones a INNER JOIN co_gruposcontablesamo g ON a.codgrupocontableamo = g.codgrupo", "g.codsubcuentaele", "codamortizacion = '" + codAmortizacion + "'", "co_amortizaciones");
	if (!codSubcuentaEle) {
		sys.warnMsgBox(sys.translate("No tiene definida una subcuenta de elemento para el grupo de amortización asociado al activo %1").arg(codAmortizacion));
		return false;
	}
	var idSubcuentaEle = AQUtil.sqlSelect("co_subcuentas", "idsubcuenta", "codsubcuenta = '" + codSubcuentaEle + "' AND codejercicio = '" + codEjercicio + "'");
	if (!idSubcuentaEle) {
		sys.warnMsgBox(sys.translate("No existe la subcuenta %1 para el ejercicio %2.\nAntes de crear la dotación para esta fecha debe crear la subcuenta").arg(codSubcuentaEle).arg(codEjercicio));
		return false;
	}
	var concepto = valoresDefecto["concepto"];

	var curPartida= new FLSqlCursor("co_partidas");
	with (curPartida) {
		setModeAccess(curPartida.Insert);
		refreshBuffer();
		setValueBuffer("idsubcuenta", idSubcuentaEle);
		setValueBuffer("codsubcuenta", codSubcuentaEle);
		setValueBuffer("idasiento", idAsiento);
		setValueBuffer("debe", 0);
		setValueBuffer("haber", importe);
		setValueBuffer("coddivisa", codDivisa);
...
function oficial_generarPartidaCierreAmorAmor(curA, idAsiento, valoresDefecto)
{
	var _i = this.iface;
	var util= new FLUtil();
	...
	var importe = curA.valueBuffer("totalamortizado");
	var importeME = importe * tasaConv;
	importe = AQUtil.roundFieldValue(importe, "co_partidas", "haber");
	importeME = AQUtil.roundFieldValue(importeME, "co_partidas", "haberme");
...
function oficial_generarPartidaCierreAmorPer(curA, idAsiento, valoresDefecto)
{
	var _i = this.iface;
	var util= new FLUtil();
	...
	var tA = curA.valueBuffer("totalamortizado");
	var vA = curA.valueBuffer("valoramortizable");
	var importe = vA - tA;
	var importeME = importe * tasaConv;
	importe = AQUtil.roundFieldValue(importe, "co_partidas", "haber");
	importeME = AQUtil.roundFieldValue(importeME, "co_partidas", "haberme");
	...
	var codSubcuentaPer = AQUtil.sqlSelect("co_amortizaciones a INNER JOIN co_gruposcontablesamo g ON a.codgrupocontableamo = g.codgrupo", "g.codsubcuentaper", "codamortizacion = '" + codAmortizacion + "'", "co_amortizaciones");
	if (!codSubcuentaPer) {
		sys.warnMsgBox(sys.translate("No tiene definida una subcuenta de pérdidas para el grupo de amortización asociado al activo %1").arg(codAmortizacion));
		return false;
	}
	var idSubcuentaPer = AQUtil.sqlSelect("co_subcuentas", "idsubcuenta", "codsubcuenta = '" + codSubcuentaPer + "' AND codejercicio = '" + codEjercicio + "'");
	if (!idSubcuentaPer) {
		sys.warnMsgBox(sys.translate("No existe la subcuenta %1 para el ejercicio %2.\nAntes de crear la dotación para esta fecha debe crear la subcuenta").arg(codSubcuentaPer).arg(codEjercicio));
		return false;
	}
	var concepto = valoresDefecto["concepto"];
	...
	with (curPartida) {
		setModeAccess(curPartida.Insert);
		refreshBuffer();
		setValueBuffer("idsubcuenta", idSubcuentaPer);
		setValueBuffer("codsubcuenta", codSubcuentaPer);
		setValueBuffer("idasiento", idAsiento);
		setValueBuffer("debe", importe);
		setValueBuffer("haber", 0);
		setValueBuffer("coddivisa", codDivisa);
...
function oficial_controlACAsientoCierreAmor(curA)
{
	var _i = this.iface;
	switch (curA.modeAccess()) {
		case curA.Del: {
			if (!flfacturac.iface.pub_eliminarAsiento(curA.valueBuffer("idasientocierre"))) {
				return false;
			}
			break;
		}
		case curA.Edit: {
			if (curA.valueBuffer("nogenerarasientocierre")) {
				var idAsientoAnterior = curA.valueBufferCopy("idasientocierre");
				if (idAsientoAnterior && idAsientoAnterior != "") {
					if (!flfacturac.iface.pub_eliminarAsiento(idAsientoAnterior)) {
						return false;
					}
				}
			} else if (curA.valueBufferCopy("idasientocierre") != curA.valueBuffer("idasientocierre")) { /// Amortización reabierta o reabierta y vuelta a cerrar
				var idAsientoAnterior = curA.valueBufferCopy("idasientocierre");
				if (idAsientoAnterior) {
					if (!flfacturac.iface.pub_eliminarAsiento(idAsientoAnterior)) {
						return false;
					}
				}
