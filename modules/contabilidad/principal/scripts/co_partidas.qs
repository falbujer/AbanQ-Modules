...
class oficial extends interna {
	...
	function borrarContrapartida() {
		return this.ctx.oficial_borrarContrapartida();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
/// Parcheado porque esto hace que datos como el IVA se actualicen solos al abrirse el formulario
	...
	try {
		sys.connectSS(this.child("tlbBorrarContrapartida"), "clicked()", this, "iface.borrarContrapartida");
	} catch (e) {
		if (this.child("tlbBorrarContrapartida")) {
			connect(this.child("tlbBorrarContrapartida"), "clicked()", this, "iface.borrarContrapartida");
		}
	}
...
function interna_validateForm():Boolean
{
	...
	if (codContrapartida) {
		...
		if(cursor.valueBuffer("idcontrapartida")) {
			sys.warnMsgBox(sys.translate("No ha borrado completamente la contrapartida. Para borrarla debe pulsasr el botón Borrar Contrpartida"));
			return false;
		}
	}
...
function oficial_borrarContrapartida()
{
	var _i = this.iface;
	
	this.child("fdbIdContrapartida").setValue("");
	this.child("fdbCodContrapartida").setValue("");
}
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
