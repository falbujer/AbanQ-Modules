...
function oficial_sumaDebeDiarioMes(nodo, campo)
{
	debug("entra")
	debug("debe " + this.iface.debeDiario);
	debug("nodo " + parseFloat(campo));
	this.iface.debeDiario += parseFloat(nodo.attributeValue(campo));

	return this.iface.debeDiario;
}

function oficial_sumaHaberDiarioMes(nodo, campo)
{
	this.iface.haberDiario += parseFloat(nodo.attributeValue(campo));
	return this.iface.haberDiario;
}
