...
class oficial extends interna {
	...
	function validaFechas() {
		return this.ctx.oficial_validaFechas();
	}
	function habilitarSI() {
		return this.ctx.oficial_habilitarSI();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// OFICIAL /////////////////////////////////////////////////////
function oficial_habilitarSI()
{
	var cursor = this.cursor();
	var habilitado = (!cursor.valueBuffer("ejercicioanterior") && cursor.valueBuffer("nivel") == "Subcuenta");
	if (!habilitado) {
		this.child("fdbSaldoInicial").setValue(false);
	}
	this.child("fdbSaldoInicial").setDisabled(!habilitado);
}
