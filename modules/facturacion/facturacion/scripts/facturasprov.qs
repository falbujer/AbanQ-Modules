...
class oficial extends interna {
	...
	{
		return this.ctx.oficial_ponSeleccionValores(valores);
	}
	...
	function habilitaPorAutomatica() {
		return this.ctx.oficial_habilitaPorAutomatica();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
class ifaceCtx extends head {
	...
	function pub_actualizarLineasIva(curFactura) {
...
function interna_validateForm()
{
	...
	if (!flfacturac.iface.pub_actualizarArticulosProv(cursor)) {
		return false;
	}
	return true;
}
...
function oficial_mostrarOpcionesFacturaRec(idFactura:String)
{
	...
	switch (opcion) {
		...
		case 1: {
			...
			aDatosFR.tabla = "lineasfacturasprov";
...
function oficial_copiarCampoLineaRec(nombreCampo, curLineaOriginal, factor, campoInformado)
{
	...
	switch (nombreCampo) {
		...
		case "pvpsindto": {
			...
			this.iface.curLineaRectificacion_.setValueBuffer("pvpsindto", formRecordlineaspedidosprov.iface.pub_commonCalculateField("pvpsindto", this.iface.curLineaRectificacion_));
			break;
		}
		case "pvptotal": {
			...
			this.iface.curLineaRectificacion_.setValueBuffer("pvptotal", formRecordlineaspedidosprov.iface.pub_commonCalculateField("pvptotal", this.iface.curLineaRectificacion_));
			break;
		}
		case "idsubcuenta": {
...
function oficial_seleccionLineasRec()
{
	...
	var curLineasRec = new FLSqlCursor("lineasfacturasprov");
...
function oficial_habilitaPorAutomatica()
{
	var _i = this.iface;
	var cursor = this.cursor();
