...
class ifaceCtx extends head
{
  ...
  function pub_imprimirESC(codTerminal: String, referencia: String)
  {
    return this.imprimirESC(codTerminal, referencia);
  }
}
...
function oficial_imprimir(referencia: String)
{
  ...
  var tipoImpresora = util.sqlSelect("tpv_puntosventa", "tipoimpresora", "codtpv_puntoventa = '" + codTerminal + "'");
...
function oficial_imprimirKugar(referencia: String)
{
  ...
  if (sys.isLoadedModule("flfactinfo")) {
    var curImprimir = new FLSqlCursor("tpv_i_vales");
...
function oficial_imprimirESC(codTerminal: String, referencia: String)
{
  ...
  var impresora = util.sqlSelect("tpv_puntosventa", "impresora", "codtpv_puntoventa = '" + codTerminal + "'");
  if (!impresora)
    return;

  flfact_tpv.iface.establecerImpresora(impresora);

  var qryVale = new FLSqlQuery("tpv_i_vales");
  ...
  flfact_tpv.iface.impNuevaLinea();
  flfact_tpv.iface.imprimirDatos(util.translate("scripts", "Importe: ") + util.roundFieldValue(qryVale.value("tpv_vales.importe"), "tpv_vales", "importe"));
  flfact_tpv.iface.impNuevaLinea();
  flfact_tpv.iface.impResaltar(true);
