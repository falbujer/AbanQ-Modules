...
class oficial extends interna {
	...
	function borrarAsientoApertura() {
		return this.ctx.oficial_borrarAsientoApertura();
	}
	function borrarAsientoPyG() {
		return this.ctx.oficial_borrarAsientoPyG();
	}
	function borrarAsientoCierre() {
		return this.ctx.oficial_borrarAsientoCierre();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function interna_init()
{
	...
	connect(this.child("tlbBorrarApertura"), "clicked()", this, "iface.borrarAsientoApertura");
	connect(this.child("tlbBorrarPyG"), "clicked()", this, "iface.borrarAsientoPyG");
	connect(this.child("tlbBorrarCierre"), "clicked()", this, "iface.borrarAsientoCierre");
...
function oficial_borrarAsientoApertura()
{
	this.child("fdbIdAsientoApertura").setValue("");
}

function oficial_borrarAsientoPyG()
{
	this.child("fdbIdAsientoReg").setValue("");
}

function oficial_borrarAsientoCierre()
{
	this.child("fdbIdAsientoCierre").setValue("");
}
