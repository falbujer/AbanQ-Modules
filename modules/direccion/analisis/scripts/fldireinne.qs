...
class oficial extends interna {
	...
	function dameDatosPaginaImpresion(visor) {
		return this.ctx.oficial_dameDatosPaginaImpresion(visor);
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
// 	function pub_dameDatosPaginaImpresion(visor) {
// 		return this.dameDatosPaginaImpresion(visor);
// 	}
}
...
/** \D Construye un array con el tipo y orientación de página que el usuario selecciona
@param	visor: Objeto FLReportViewer donde se mostrará la página.
\end */
// function oficial_dameDatosPaginaImpresion(visor)
// {
// 	var util = new FLUtil;
// 	var dialog:Dialog = new Dialog;
// 	dialog.okButtonText = util.translate("scripts","Aceptar");
// 	dialog.cancelButtonText = util.translate("scripts","Cancelar");
// 	
// 	var aDesTamanoPag = ["Personalizado", "A4", "B5", "Letter"];
// 	var aCodTamanoPag = [];
// 	aCodTamanoPag["Personalizado"] = -1;
// 	aCodTamanoPag["A4"] = visor.A4;
// 	aCodTamanoPag["B5"] = visor.B5;
// 	aCodTamanoPag["Letter"] = visor.Letter;
// 	
// 	var cboTamano = new ComboBox;
// 	cboTamano.itemList = aDesTamanoPag;
// 	cboTamano.label = util.translate("scripts", "Tamaño");
// 	dialog.add(cboTamano);
// 	
// 	var chkApaisado = new CheckBox;
// 	chkApaisado.text = util.translate("scripts", "Apaisado");
// 	dialog.add(chkApaisado);
// 	
// 	if (!dialog.exec()) {
// 		return false;
// 	}
// 	var resultado = new Object();
// 	resultado.orientacion = chkApaisado.checked ? visor.Landscape : visor.Portrait;
// 	resultado.tamano = aCodTamanoPag[cboTamano.currentItem];
// 	return resultado;
// }
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
