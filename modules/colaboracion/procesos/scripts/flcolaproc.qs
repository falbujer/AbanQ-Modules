...
class interna {
	...
	function afterCommit_pr_tareas(curTarea:FLSqlCursor) {
		return this.ctx.interna_afterCommit_pr_tareas(curTarea);
	}
	function afterCommit_pr_tipostareapro(curTTP:FLSqlCursor) {
...
class oficial extends interna {
	...
	function crearProceso(tipoProceso:String, tipoObjeto:String, idObjeto:String) {
		return this.ctx.oficial_crearProceso(tipoProceso, tipoObjeto, idObjeto);
	}
	function activarTarea(curTareaPrevia:FLSqlCursor, idTipoTareaPro:String) {
		return this.ctx.oficial_activarTarea(curTareaPrevia, idTipoTareaPro);
	}
	function activacionPosibleTarea(idProceso:String, idTipoTareaPro:String, numCiclo:String) {
	...
	function tiempoMedioProceso(idTipoProceso:String) {
		return this.ctx.oficial_tiempoMedioProceso(idTipoProceso);
	}
	function tiempoUnidadProceso(idTipoProceso:String) {
		return this.ctx.oficial_tiempoUnidadProceso(idTipoProceso);
	}
	function tiempoMedioTarea(idTipoTarea:String) {
		return this.ctx.oficial_tiempoMedioTarea(idTipoTarea);
	}
	function iniciarProceso(idProceso:String) {
		return this.ctx.oficial_iniciarProceso(idProceso);
	}
	function calcularIntervalo(diaInicio:Date, tiempoInicio:Time, momentoFin:Date) {
		return this.ctx.oficial_calcularIntervalo(diaInicio, tiempoInicio, momentoFin)
	}
	function terminarProceso(idProceso:String) {
		return this.ctx.oficial_terminarProceso(idProceso);
	}
	function terminarTarea(curTareas:FLSqlCursor) {
		return this.ctx.oficial_terminarTarea(curTareas);
	}
	function activarSiguientesTareas(curTareas:FLSqlCursor) {
		return this.ctx.oficial_activarSiguientesTareas(curTareas);
	}
	function desactivarSiguientesTareas(curTareas:FLSqlCursor) {
		return this.ctx.oficial_desactivarSiguientesTareas(curTareas);
	}
	function esTareaInicial(idTipoTarea:String) {
		return this.ctx.oficial_esTareaInicial(idTipoTarea);
	}
	function cambiarEstadoObjeto(idProceso:Number, estadoProceso:String) {
		return this.ctx.oficial_cambiarEstadoObjeto(idProceso, estadoProceso);
	}
	function estadoObjeto(idProceso:Number) {
		return this.ctx.oficial_estadoObjeto(idProceso);
	}
	function deshacerProcesoTerminado(idProceso:String) {
		return this.ctx.oficial_deshacerProcesoTerminado(idProceso);
	}
	function deshacerProcesoEnCurso(idProceso:String) {
		return this.ctx.oficial_deshacerProcesoEnCurso(idProceso);
	}
	function deshacerTareaTerminada(curTareas:FLSqlCursor) {
		return this.ctx.oficial_deshacerTareaTerminada(curTareas);
	}
	function deshacerTareaEnCurso(curTareas:FLSqlCursor) {
		return this.ctx.oficial_deshacerTareaEnCurso(curTareas);
	}
	function estadoObjetoInicial(idProceso:Number) {
		return this.ctx.oficial_estadoObjetoInicial(idProceso);
	}
	function borrarProceso(idProceso:Number) {
		return this.ctx.oficial_borrarProceso(idProceso);
	}
	function detenerProceso(idProceso:Number) {
		return this.ctx.oficial_detenerProceso(idProceso);
	}
	function cancelarProceso(idProceso:Number) {
		return this.ctx.oficial_cancelarProceso(idProceso);
	}
	function reanudarProceso(idProceso:Number) {
		return this.ctx.oficial_reanudarProceso(idProceso);
	}
	function previoReanudarProceso(idProceso:Number) {
		return true; /// Función a sobrecargar
	}
	function previoDetenerProceso(idProceso:Number) {
		return true; /// Función a sobrecargar
	}
	function previoCancelarProceso(idProceso:Number) {
		return true; /// Función a sobrecargar
	}
	function cerosIzquierda(numero:String, totalCifras:Number) {
		return this.ctx.oficial_cerosIzquierda(numero, totalCifras);
	}
	function calcularIdTarea() {
		return this.ctx.oficial_calcularIdTarea();
	}
	function crearSecuenciaTareas(prefijo, numTarea) {
		return this.ctx.oficial_crearSecuenciaTareas(prefijo, numTarea);
	}
	function iniciarTareaEsp(curTareas:FLSqlCursor) {
		return true; //Función a sobrecargar
	}
	function terminarTareaEsp(curTareas:FLSqlCursor) {
		return true; //Función a sobrecargar
	}
	function deshacerTareaTerminadaEsp(curTareas:FLSqlCursor) {
		return true; //Función a sobrecargar
	}
	function deshacerTareaEnCursoEsp(curTareas:FLSqlCursor) {
		return true; //Función a sobrecargar
	}
	function iniciarProcesoEsp(idProceso:String) {
		return true; //Función a sobrecargar
	} 
	function terminarProcesoEsp(curProceso:FLSqlCursor) {
		return true; //Función a sobrecargar
	}
	function deshacerProcesoTerminadoEsp(idProceso:String) {
		return true; //Función a sobrecargar
	}
	function deshacerProcesoEnCursoEsp(idProceso:String) {
		return true; //Función a sobrecargar
	}
	function descripcionTarea(curTarea:FLSqlCursor) {
		return this.ctx.oficial_descripcionTarea(curTarea);
	}
	function asignarTareas(idProceso:String, idTipoProceso:String) {
		return this.ctx.oficial_asignarTareas(idProceso, idTipoProceso);
	}
	function seguimientoOn(container:Object, datosS:Array) {
		return this.ctx.oficial_seguimientoOn(container, datosS);
	}
	function seguimientoOff() {
	...
	function tbnIniciarTareaSClicked(idUsuario:String) {
		return this.ctx.oficial_tbnIniciarTareaSClicked(idUsuario);
	}
	function iniciaTareaTr(idTarea, idUsuario) {
		return this.ctx.oficial_iniciaTareaTr(idTarea, idUsuario);
	}
	function tbnDeshacerTareaSClicked() {
		return this.ctx.oficial_tbnDeshacerTareaSClicked();
	}
	function tbnCancelarProcesoSClicked() {
		return this.ctx.oficial_tbnCancelarProcesoSClicked();
	}
	function tbnDetenerProcesoSClicked() {
		return this.ctx.oficial_tbnDetenerProcesoSClicked();
	}
	function tbnReanudarProcesoSClicked() {
	...
	function elegirOpcion(opciones:Array) {
		return this.ctx.oficial_elegirOpcion(opciones);
	}
	function notificar(mensaje:Array) {
	...
	function procesarEvento(datosEvento:Array) {
	...
	function arrayAccion(contexto:String, accion:String) {
		return this.ctx.oficial_arrayAccion(contexto, accion);
	}
	function terminarTareaPorEstado(curTarea:FLSqlCursor) {
		return this.ctx.oficial_terminarTareaPorEstado(curTarea);
	}
	function ponerTareaEnCursoPorEstado(curTarea:FLSqlCursor) {
		return this.ctx.oficial_ponerTareaEnCursoPorEstado(curTarea);
	}
	function ponerTareaPtePorEstado(curTarea:FLSqlCursor) {
		return this.ctx.oficial_ponerTareaPtePorEstado(curTarea);
	}
	function dormirTareaPorEstado(curTarea:FLSqlCursor, fechaActivacion:String) {
		return this.ctx.oficial_dormirTareaPorEstado(curTarea, fechaActivacion);
	}
	function dormirTarea(curTarea:FLSqlCursor, fechaActivacion:String) {
		return this.ctx.oficial_dormirTarea(curTarea, fechaActivacion);
	}
	function despertarTarea(curTarea:FLSqlCursor) {
		return this.ctx.oficial_despertarTarea(curTarea);
	}
	function calcularFechaActivacion(curTarea:FLSqlCursor) {
	...
	function despertarTareaEsp(curTarea:FLSqlCursor) {
		return true;
	}
	function globalInit() {
	...
	function lanzarPreavisos() {
		return this.ctx.oficial_lanzarPreavisos();
	}
	function controlPreavisos() {
		return this.ctx.oficial_controlPreavisos();
	}
	function matarTimer() {
		return this.ctx.oficial_matarTimer();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
class ifaceCtx extends head {
	...
	function pub_terminarTarea(curTareas:FLSqlCursor) {
		return this.terminarTarea(curTareas);
	}
	function pub_iniciarTarea(curTareas:FLSqlCursor, idUser:String, ignorarEstadistica:Boolean) {
		return this.iniciarTarea(curTareas, idUser, ignorarEstadistica);
	}
	function pub_crearProceso(tipoProceso:String, tipoObjeto:String, idObjeto:String) {
		return this.crearProceso(tipoProceso, tipoObjeto, idObjeto);
	}
	function pub_deshacerTareaTerminada(curTareas:FLSqlCursor) {
		return this.deshacerTareaTerminada(curTareas);
	}
	function pub_deshacerTareaEnCurso(curTareas:FLSqlCursor) {
		return this.deshacerTareaEnCurso(curTareas);
	}
	function pub_borrarProceso(idProceso:Number) {
		return this.borrarProceso(idProceso);
	}
	function pub_detenerProceso(idProceso:Number) {
		return this.detenerProceso(idProceso);
	}
	function pub_cancelarProceso(idProceso:Number) {
		return this.cancelarProceso(idProceso);
	}
	function pub_reanudarProceso(idProceso:Number) {
		return this.reanudarProceso(idProceso);
	}
	function pub_cerosIzquierda(numero:String, totalCifras:Number) {
		return this.cerosIzquierda(numero, totalCifras);
	}
	function pub_formatearCodigo( lineEdit:Object, longCodigo:Number, posPuntoActual:Number ) {
		return this.formatearCodigo( lineEdit, longCodigo, posPuntoActual );
	}
	function pub_seguimientoOn(container:Object, datosS:Array) {
	...
	function pub_tbnIniciarTareaSClicked(idUsuario:String) {
		return this.tbnIniciarTareaSClicked(idUsuario);
	}
	function pub_iniciaTareaTr(idTarea, idUsuario) {
		return this.iniciaTareaTr(idTarea, idUsuario);
	}
	function pub_tbnDetenerProcesoSClicked(idUsuario:String) {
		return this.tbnDetenerProcesoSClicked(idUsuario);
	}
	function pub_tbnCancelarProcesoSClicked(idUsuario:String) {
		return this.tbnCancelarProcesoSClicked(idUsuario);
	}
	function pub_tbnReanudarProcesoSClicked(idUsuario:String) {
		return this.tbnReanudarProcesoSClicked(idUsuario);
	}
	function pub_regenerarFiltroS() {
		return this.regenerarFiltroS();
	}
	function pub_procesarEvento(datosEvento:Array) {
		return this.procesarEvento(datosEvento);
	}
	function pub_tiempoUnidadProceso(idTipoProceso:String) {
	...
	function pub_convertirTiempoProceso(s:Number, idProceso:String) {
		return this.convertirTiempoProceso(s, idProceso);
	}
	function pub_convertirTiempoMS(tiempoProceso:Number, idProceso:String) {
		return this.convertirTiempoMS(tiempoProceso, idProceso);
	}
	function pub_borrarProcesosAsociados(tipoObjeto:String, idObjeto:String) {
		return this.borrarProcesosAsociados(tipoObjeto, idObjeto);
	}
	function pub_accionesAuto() {
		return this.accionesAuto();
	}
	function pub_setAccionesAuto(aa:Array) {
		return this.setAccionesAuto(aa);
	}
	function pub_arrayAccion(contexto:String, accion:String) {
		return this.arrayAccion(contexto, accion);
	}
	function pub_terminarTareaPorEstado(curTarea:FLSqlCursor) {
		return this.terminarTareaPorEstado(curTarea);
	}
	function pub_ponerTareaEnCursoPorEstado(curTarea:FLSqlCursor) {
		return this.ponerTareaEnCursoPorEstado(curTarea);
	}
	function pub_ponerTareaPtePorEstado(curTarea:FLSqlCursor) {
		return this.ponerTareaPtePorEstado(curTarea);
	}
	function pub_dormirTareaPorEstado(curTarea:FLSqlCursor, fechaActivacion:String) {
		return this.dormirTareaPorEstado(curTarea, fechaActivacion);
	}
	function pub_dormirTarea(curTarea:FLSqlCursor, fechaActivacion:String) {
...
function interna_afterCommit_pr_tareas(curTarea:FLSqlCursor)
{
	var util= new FLUtil;
	switch (curTarea.modeAccess()) {
		case curTarea.Edit: {
			var idTarea= curTarea.valueBuffer("idtarea");
			var idTipoTareaPro= curTarea.valueBuffer("idtipotareapro");
			if ((curTarea.valueBuffer("iduser") != "" && curTarea.valueBufferCopy("estado") == "OFF" && curTarea.valueBuffer("estado") == "PTE") || (curTarea.valueBuffer("iduser") != "" && curTarea.valueBufferCopy("iduser") != curTarea.valueBuffer("iduser") && curTarea.valueBuffer("estado") == "PTE")) {
				if (util.sqlSelect("pr_tipostareapro", "notificarasignacion", "idtipotareapro = " + idTipoTareaPro)) {
					var mensaje= this.iface.initMensaje();
...
function interna_afterCommit_pr_tipostareapro(curTTP:FLSqlCursor)
{
	var util= new FLUtil;

	switch (curTTP.modeAccess()) {
		case curTTP.Del: {
			var idTipoTareaPro= curTTP.valueBuffer("idtipotareapro");
...
function oficial_valoresIniciales()
{
	...
	var cursor= new FLSqlCursor("pr_tiposproceso");
	...
	var cursor= new FLSqlCursor("pr_tipostarea");
	for (var i= 0; i < values.length; i++) {
		with(cursor) {
			setModeAccess(cursor.Insert);
			refreshBuffer();
	...
	var cursor= new FLSqlCursor("pr_tipostareapro");
	for (var i= 0; i < values.length; i++) {
		with(cursor) {
			setModeAccess(cursor.Insert);
			refreshBuffer();
...
\end */
function oficial_crearProceso(tipoProceso:String, tipoObjeto:String, idObjeto:String)
{
	var idProceso:Number;
	var util= new FLUtil;
	var curProceso= new FLSqlCursor("pr_procesos");
	var tipoObjetoProceso= util.sqlSelect("pr_tiposproceso","tipoobjeto","idtipoproceso = '" + tipoProceso + "'");
	...
	var generarTodas= util.sqlSelect("pr_tiposproceso", "generartodas", "idtipoproceso = '" + tipoProceso + "'");
	...
	var qryTiposTarea= new FLSqlQuery();
	with (qryTiposTarea) {
	...
	var xmlProceso= this.iface.crearXMLProceso(curProceso);
	if (!xmlProceso) {
		return false;
	}
...
\end */
function oficial_asignarTareas(idProceso:String, idTipoProceso:String)
{
	var util= new FLUtil;
	var arrayAlias= [];
	var qryAlias= new FLSqlQuery();
	...
	var usuarioActual= sys.nameUser();
	var idUser:String;
	var idGroup:String;
	var idAsignacion:String;
	while (qryAlias.next()) {
		var fAlias= new FLFormSearchDB("pr_asignaralias");
		var curAsignar= fAlias.cursor();
		...
		if (idAsignacion) {
			...
			var qryAsignarAlias= new FLSqlQuery;
...
@return	Descripción
\end */
function oficial_descripcionTarea(curTarea:FLSqlCursor)
{
	var util= new FLUtil;
...
\end */
function oficial_calcularIdTarea()
{
	var util = new FLUtil();
	var prefijo = util.sqlSelect("pr_secuenciastareas", "MAX(prefijo)", "1 = 1");
	if (!prefijo) {
		prefijo = "TA";
	}
	var ultimaTarea= util.sqlSelect("pr_secuenciastareas", "valor", "prefijo = '" + prefijo + "'");

	if (!ultimaTarea) {
		var idUltima= util.sqlSelect("pr_tareas", "idtarea", "idtarea LIKE '" + prefijo + "%' ORDER BY idtarea DESC");
		if (idUltima) {
		...
		ultimaTarea += 1;
		if (!this.iface.crearSecuenciaTareas(prefijo, ultimaTarea)) {
			return false;
		}
	}
	else {
		ultimaTarea += 1;
		if (ultimaTarea > 999999) {
			var sPre = "ABCDEFGHIJKLMNOPQRSTUVWYZ";
			var l = prefijo.charAt(1);
			var iPre = sPre.find(l);
			if (iPre >= 0 && iPre < sPre.length) {
				iPre++;
				prefijo = "T" + sPre.charAt(iPre);
				ultimaTarea = 1;
				if (!this.iface.crearSecuenciaTareas(prefijo, ultimaTarea)) {
					return false;
				}
			} else {
				MessageBox.warning(util.translate("scripts", "Error al realizar automáticamente el cambio de prefijo en tareas"), MessageBox.Ok, MessageBox.NoButton);
				return false;
			}
		} else {
	...
	var id= prefijo + flfacturac.iface.pub_cerosIzquierda((ultimaTarea).toString(), 6);

	return id;
}

function oficial_crearSecuenciaTareas(prefijo, numTarea)
{
	var util= new FLUtil();
...
\end */
function oficial_activarTarea(curTareaPrevia:FLSqlCursor, idTipoTareaPro:String)
{
debug("Activar tarea");
	var util= new FLUtil();
	var estado:String;

	var idProceso= curTareaPrevia.valueBuffer("idproceso");
	var idObjeto= curTareaPrevia.valueBuffer("idobjeto");
	var tipoObjeto= curTareaPrevia.valueBuffer("tipoobjeto");
	...
	var activable= this.iface.activacionPosibleTarea(idProceso, idTipoTareaPro, numCiclo);
	if (activable != 1) {
		return activable;
	}
	...
	if (!this.iface.curTarea_.first()) {
		var numCiclo= parseInt(util.sqlSelect("pr_tareas", "COUNT(*)", "idproceso = " + idProceso + " AND idtipotareapro = " + idTipoTareaPro));
		...
		this.iface.curTarea_.setValueBuffer("descripcion", this.iface.descripcionTarea(this.iface.curTarea_));
		var datosAsignacion= this.iface.calcularAsignacionTarea();
		if (datosAsignacion) {
	...
	var fechasPrevistas= this.iface.dameFechasPrevistas(this.iface.curTarea_);
	var hoy= new Date;
	var asignado= this.iface.curTarea_.valueBuffer("iduser");
...
\end */
function oficial_activacionPosibleTarea(idProceso:String, idTipoTareaPro:String, numCiclo:String)
{
	var util= new FLUtil();
	
	var tareaInicial= util.sqlSelect("pr_tipostareapro", "tareainicial", "idtipotareapro = " + idTipoTareaPro);
debug("activando " + tareaInicial);
	var qryPrevias= new FLSqlQuery;
...
function oficial_dameFechasPrevistas(curTarea:FLSqlCursor)
{
debug("oficial_dameFechasPrevistas");
	var qryTipoTarea= new FLSqlQuery;
	...
	var ahora= new Date;
	var mAhora= ahora.getTime();
	var milisegundos:Number;
	var unidadTiempo= qryTipoTarea.value("tp.unidad");
	switch (unidadTiempo) {
		case "Segundos": {
			milisegundos = 1000;
			break;
	...
	var mInicio= mAhora + milisegundos * parseFloat(qryTipoTarea.value("tt.tiempopteencurso"));
debug(mInicio);
	var mFin= mAhora + milisegundos * parseFloat(qryTipoTarea.value("tt.tiempopteterminada"));
debug(mFin);
	var fechaInicio= new Date(mInicio);
	var fechaFin= new Date(mFin);
debug(fechaFin.toString());
	var xmlDoc= new FLDomDocument;
	var eFechas= xmlDoc.createElement("Fechas");
...
function oficial_iniciarTarea(curTareas:FLSqlCursor, idUser:String, ignorarEstadistica:Boolean)
{
	...
	var idTipoTareaPro= curTareas.valueBuffer("idtipotareapro");
	var idTarea= curTareas.valueBuffer("idtarea");
	var idProceso= curTareas.valueBuffer("idproceso");
	var estado= curTareas.valueBuffer("estado");

	var fechaInicio= new Date();
	var horaInicio= fechaInicio.toString().substring(11, 19);
...
\end */
	if (this.iface.esTareaInicial(idTipoTareaPro)) {
		...
		var estadoObjeto= this.iface.estadoObjetoInicial(idProceso);
...
\end */
function oficial_esTareaInicial(idTipoTareaPro:String)
{
	var util= new FLUtil();
	var tareaInicial= util.sqlSelect("pr_tipostareapro", "tareainicial", "idtipotareapro = " + idTipoTareaPro);
...
function oficial_terminarTarea(curTareas:FLSqlCursor)
{
	var util= new FLUtil();
	var idTipoTarea= curTareas.valueBuffer("idtipotarea");
	var idTipoTareaPro= curTareas.valueBuffer("idtipotareapro");
	...
	if (!qryTiposTarea.first())
		return false;
	var subestadoProceso= qryTiposTarea.value("subestadoproceso");
	var estadoObjeto= qryTiposTarea.value("estadoobjeto");
	...
	var horaFin= fechaFin.toString().substring(11, 19);
	with(curTareas) {
	...
	var tareaFinal= util.sqlSelect("pr_tipostareapro", "tareafinal", "idtipotareapro = " + idTipoTareaPro);
...
function oficial_calcularTiemposFinalizacionTarea(curTareas:FLSqlCursor,fechaFin:Date)
{
	var intervalo= this.iface.calcularIntervalo(curTareas.valueBuffer("diainicio"), curTareas.valueBuffer("tiempoinicio"), fechaFin);
...
\end */
function oficial_activarSiguientesTareas(curTareas:FLSqlCursor)
{
	var util= new FLUtil;
	var idTipoTareaPro= curTareas.valueBuffer("idTipoTareaPro");
	var idProceso= curTareas.valueBuffer("idProceso");
	var qrySiguienteTarea= new FLSqlQuery();
...
\end */
function oficial_terminarProceso(idProceso:String)
{
	var util= new FLUtil();
	var fechaFin= new Date();
	var horaFin= fechaFin.toString().substring(11, 19);
	...
	var intervalo= this.iface.calcularIntervalo(curProceso.valueBuffer("diainicio"), curProceso.valueBuffer("tiempoinicio"), fechaFin);
...
@return VERDADERO si el proceso finaliza correctamente. FALSO en otro caso
\end */
function oficial_deshacerProcesoTerminado(idProceso:String)
{
	var util= new FLUtil();
	var fechaFin= new Date();
	var horaFin= fechaFin.toString().substring(11, 19);
...
// 	var idTipoProceso= util.sqlSelect("pr_procesos", "idtipoproceso", "idproceso = " + idProceso);
// 	var codLote= util.sqlSelect("pr_procesos", "idobjeto", "idproceso = " + idProceso);
...
\end */
function oficial_calcularIntervalo(diaInicio:Date, tiempoInicio:Time, momentoFin:Date)
{
	var intervalo= new Number;
	var longTiempoInicio= tiempoInicio.toString().length;
	var horaInicio= diaInicio.toString().substring(0, 10) + ":" + tiempoInicio.toString().substring(longTiempoInicio - 8, longTiempoInicio);
	var momentoInicio= new Date(Date.parse(horaInicio));
...
\end */
function oficial_iniciarProceso(idProceso:String)
{
	var util= new FLUtil();

	var estado= util.sqlSelect("pr_procesos", "estado", "idproceso = " + idProceso);
	if (estado != "PTE")
		return true;

	var estadoObjeto= this.iface.estadoObjeto(idProceso);
	if (!estadoObjeto && estadoObjeto != "") {
	...
	var result= util.sqlUpdate("pr_procesos", "tiempoinicio,diainicio,estado,estadoprevio",  horaInicio + "," + fechaInicio + ",EN CURSO," + estadoObjeto, "idproceso = " + idProceso);
...
\end */
function oficial_deshacerProcesoEnCurso(idProceso:String)
{
	var util= new FLUtil();
...
\end */
function oficial_tiempoMedioTarea(idTipoTarea:String)
{
	var util= new FLUtil();
	var tiempoMedio= util.sqlSelect("pr_tareas", "AVG(intervalo)", "idtipotarea = '" + idTipoTarea + "'");
	if (!tiempoMedio)
		return false;
...
@return VERDADERO si el cálculo se realiza correctamente. FALSO en otro caso
\end */
function oficial_tiempoMedioProceso(idTipoProceso:String)
{
	var util= new FLUtil();
	var tiempoMedio= util.sqlSelect("pr_procesos", "AVG(intervalo)", "idtipoproceso = '" + idTipoProceso + "'");
...
@return VERDADERO si el cálculo se realiza correctamente. FALSO en otro caso
\end */
function oficial_tiempoUnidadProceso(idTipoProceso:String)
{
	var util= new FLUtil();
	var unidad= "";
	var tiempoUnidad= 0;
	var tiempoMedio= parseFloat(util.sqlSelect("pr_tiposproceso", "tiempomedio", "idtipoproceso = '" + idTipoProceso + "'"));
...
\end */
function oficial_deshacerTareaTerminada(curTareas:FLSqlCursor)
{
	var util= new FLUtil();
	var idTipoTarea= curTareas.valueBuffer("idtipotarea");
	var idTipoTareaPro= curTareas.valueBuffer("idtipotareapro");
...
\end */
	...
	var estadoProceso= util.sqlSelect("pr_procesos", "estado", "idProceso = " + idProceso);
...
\end */
	var esTareaFinal= util.sqlSelect("pr_tipostareapro", "tareafinal", "idtipotareapro = " + idTipoTareaPro);
	if (!esTareaFinal) {
...
\end */
	var subestadoProceso= "";
	var qryEstadoProceso= new FLSqlQuery();
...
\end */
	var estadoObjeto= "";
	var qryEstadoObjeto= new FLSqlQuery();
	with (qryEstadoObjeto) {
		setTablesList("pr_tareas,pr_tipostareapro");
		setSelect("tt.estadoobjeto");
		setFrom("pr_tareas t INNER JOIN pr_tipostareapro tt ON t.idtipotareapro = tt.idtipotareapro");
		setWhere("t.idproceso = " + idProceso + " AND t.estado = 'TERMINADA' AND tt.estadoobjeto IS NOT NULL ORDER BY t.diafin DESC, t.tiempofin DESC");
	}
...
function oficial_desactivarSiguientesTareas(curTareas:FLSqlCursor)
{
	var util= new FLUtil();
	var idTipoTareaPro= curTareas.valueBuffer("idtipotareapro");
	var idProceso= curTareas.valueBuffer("idproceso");
	...
	var estadoTareaSiguiente= "";
	while (qrySiguienteTarea.next()) {
		var qryDatosTareaSig= new FLSqlQuery;
...
\end */
function oficial_cambiarEstadoObjeto(idProceso:Number, estadoObjeto:String)
{
	var util= new FLUtil;
	if (!estadoObjeto || estadoObjeto == "")
		return true;

	var qryProceso= new FLSqlQuery();
	with (qryProceso) {
	...
	if (!qryProceso.first())
		return false;
	var idObjeto= qryProceso.value(0);
	var tipoObjeto= qryProceso.value(1);
...
\end */
function oficial_actualizarEstadoObjeto(tipoObjeto:String, idObjeto:String, estadoObjeto:String)
{
	var util= new FLUtil;
	var curObjeto= new FLSqlCursor(tipoObjeto);
...
\end */
function oficial_estadoObjeto(idProceso:Number)
{
	var util= new FLUtil;
	...
	var estado= curObjeto.valueBuffer("estado");
	if (!estado) {
		estado = "";
	}
	return estado;
...
@return VERDADERO si la tarea ha sido deshecha. FALSO en otro caso
\end */
function oficial_deshacerTareaEnCurso(curTareas:FLSqlCursor)
{
	var util= new FLUtil();
	var idTipoTarea= curTareas.valueBuffer("idtipotarea");
	var idTipoTareaPro= curTareas.valueBuffer("idtipotareapro");
	...
	if (this.iface.esTareaInicial(idTipoTareaPro)) {
		if (!util.sqlSelect("pr_tareas", "idtarea", "idproceso = " + idProceso + " AND estado NOT IN ('PTE', 'OFF')")) {
			if (!this.iface.deshacerProcesoEnCurso(idProceso))
				return false;
			var estadoObjeto= util.sqlSelect("pr_procesos", "estadoprevio", "idproceso = " + idProceso);
			if (!this.iface.cambiarEstadoObjeto(idProceso, estadoObjeto))
				return false;
		}
	}
...
\end */
function oficial_estadoObjetoInicial(idProceso:Number)
{
	return "EN CURSO";
}
...
\end */
function oficial_borrarProceso(idProceso:Number)
{
	var util= new FLUtil();
	var estadoProceso= util.sqlSelect("pr_procesos", "estado", "idproceso = " + idProceso);
	...
	var hayTareasIniciadas= util.sqlSelect("pr_tareas", "idtarea", "idproceso = " + idProceso + " AND estado NOT IN ('PTE', 'OFF')");
	...
	var paso= 0;
	var curProcesos= new FLSqlCursor("pr_procesos");
...
\end */
function oficial_detenerProceso(idProceso:Number)
{
	...
	var hayTareasEnCurso= util.sqlSelect("pr_tareas", "idtarea", "idproceso = " + idProceso + " AND estado = 'EN CURSO'");
	if (hayTareasEnCurso) {
...
\end */
function oficial_cancelarProceso(idProceso:Number)
{
...
\end */
function oficial_reanudarProceso(idProceso:Number)
{
...
\end */
function oficial_seguimientoOn(container:Object, datosS:Array)
{
	var util= new FLUtil;
	...
	var tdbTareasS= this.iface.container_.child("tdbTareasS");
	if (!tdbTareasS) {
		return false;
	}
...
function oficial_regenerarFiltroS()
{
	...
	var filtroEs= this.iface.filtroEstadoS();
	if (filtroEs) {
		if (filtro != "") {
			filtro += " AND ";
		}
	...
	var filtroPro= this.iface.filtroPropietarioS();
	if (filtroPro) {
		if (filtro != "") {
			filtro += " AND ";
		}
...
@return	Filtro
\end */
function oficial_filtroEstadoS()
{
	if (!this.iface.chkPteS) {
		return "1 = 1";
	}
...
@return	Filtro
\end */
function oficial_filtroPropietarioS()
{
	if (!this.iface.chkMiasS)
		return "1 = 1";
	...
	var idGrupo= util.sqlSelect("flusers", "idgroup", "iduser = '" + idUsuario + "'");
...
\end */
function oficial_tbnIniciarTareaSClicked(idUsuario)
{
	var _i = this.iface;
	...
	if (!_i.iniciaTareaTr(this.iface.cursor_.valueBuffer("idtarea"), idUsuario)) {
		return false;
	}
...
function oficial_iniciaTareaTr(idTarea, idUsuario)
{
	var _i = this.iface;
	...
	if (!AQUtil.sqlSelect("flusers", "iduser", "iduser = '" + idUsuario + "'")) {
		sys.warnMsgBox(sys.translate("El usuario actual (%1) no está dado de alta en la tabla de usuarios del módulo de Administración.\nDebe dar de alta este usuario antes de realizar tareas con él.").arg(idUsuario));
		return false;
	}
	var curTarea = new FLSqlCursor("pr_tareas");
	curTarea.select("idtarea = '" + idTarea + "'");
	if (!curTarea.first()) {
		sys.warnMsgBox(sys.translate("La tarea (%1) no existe").arg(idTarea));
		return false;
	}
	...
	var ok = true;
	if (curTarea.valueBuffer("estado") == "EN CURSO") {
		curT.transaction(false);
		try {
			if (_i.terminarTarea(curTarea))
				curT.commit();
			else {
				curT.rollback();
				ok = false;
			...
			ok = false;
			curT.rollback();
			sys.errorMsgBox(sys.translate("Hubo un error en la finalización de la tarea:\n") + e);
		}
		return ok;
	}
	
	if (curTarea.valueBuffer("estado") == "PTE") {
		var unPaso = AQUtil.sqlSelect("pr_tipostareapro", "terminaenunpaso", "idtipotareapro = " + curTarea.valueBuffer("idtipotareapro"));
		
		curT.transaction(false);
		try {
			if (_i.iniciarTarea(curTarea, idUsuario))
				if (unPaso) {
					if (_i.terminarTarea(curTarea)) {
						curT.commit();
					} else {
			...
			ok = false;
			curT.rollback();
			sys.errorMsgBox(sys.translate("Hubo un error en la inicio de la tarea:\n") + e);
		}
		return ok;
	}
	sys.warnMsgBox(sys.translate("La tarea %1 no está en estado PTE o EN CURSO").arg(idTarea));
	return false;
}
...
\end */
function oficial_tbnDetenerProcesoSClicked()
{
	var util= new FLUtil;
	var ok= true;
	if (!this.iface.cursor_.isValid()) {
	...
	var idProceso= this.iface.cursor_.valueBuffer("idproceso");
...
\end */
function oficial_tbnCancelarProcesoSClicked()
{
	var util= new FLUtil;
	var ok= true;
	if (!this.iface.cursor_.isValid()) {
...
\end */
function oficial_tbnReanudarProcesoSClicked()
{
	var util= new FLUtil;
	var ok= true;
	if (!this.iface.cursor_.isValid()) {
...
\end */
function oficial_tbnDeshacerTareaSClicked()
{
	if (!this.iface.cursor_.isValid())
		return false;
	...
	var estado= this.iface.cursor_.valueBuffer("estado");
	...
	var unPaso= util.sqlSelect("pr_tipostareapro", "terminaenunpaso", "idtipotareapro = " + this.iface.cursor_.valueBuffer("idtipotareapro"));
	var ok= true;
	try {
		this.iface.cursor_.transaction(false);
		if (estado == "TERMINADA") {
...
{
	var idTipoTarea= this.iface.cursor_.valueBuffer("idtipotarea");
	switch (idTipoTarea) {
		default: {
...
function oficial_tbnLanzarTareaSClicked()
{
	...
	var tipoProceso= this.iface.obtenerTipoProcesoS();
	if (!tipoProceso)
		return false;
...
function oficial_obtenerTipoProcesoS()
{
	...
	switch (this.iface.tipoObjeto_) {
		...
		case "crm_incidencias": {
			...
			var procesoElegido= this.iface.elegirOpcion(arrayOpciones);
			if (procesoElegido < 0)
				return false;
		...
		default: {
			var f= new FLFormSearchDB("pr_tiposproceso");
			f.setMainWidget();
...
@return	El índice de la opción elegida si se pulsa Aceptar
		...
		-2 si hay error
\end */
function oficial_elegirOpcion(opciones:Array)
{
	var util= new FLUtil();
...
|end */
function oficial_notificar(mensaje:Array)
{
	var util= new FLUtil;
...
function oficial_procesarEvento(datosEvento:Array)
{
	return true; // Función a sobrecargar 
}
...
{
	var util= new FLUtil();
	var tiempo= this.iface.calcularTiempo(tipoObjeto, idObjeto);
	if (isNaN(tiempo))
		return false;
...
function oficial_calcularTiempo(tipoObjeto:String, idObjeto:String)
{
	var util= new FLUtil();
	var total:Number;
	switch (tipoObjeto) {
		...
		case "cl_proyectos": {
			var tiempoTareas= util.sqlSelect("pr_tareas", "SUM(tiempoinvertido)", "tipoobjeto = '" + tipoObjeto + "' AND idobjeto = '" + idObjeto + "'");
			if (isNaN(tiempoTareas))
				return false;

			var tiempoSubp= util.sqlSelect("cl_subproyectos", "SUM(tiempototal)", "codproyecto = '" + idObjeto + "'");
			if (isNaN(tiempoSubp))
				return false;
...
\end */
function oficial_convertirTiempoProceso(s:Number, idProceso:String)
{
	var util= new FLUtil;
	var valor:Number;
	var unidades:String;
...
\end */
function oficial_convertirTiempoMS(tiempoProceso:Number, idProceso:String)
{
	var util= new FLUtil;
	var valor:Number;
	var unidades:String;
...
\end */
function oficial_comprobarTotalTiempoProceso(curTarea:FLSqlCursor)
{
	switch (curTarea.modeAccess()) {
		case curTarea.Edit: {
...
@param	curTarea: Cursor asociado a la tarea que se ha modificado
\end */
function oficial_actualizarTotalTiempoProceso(curTarea:FLSqlCursor)
{
	var curProceso= curTarea.cursorRelation();
...
function oficial_calcularTiempoInvertido(curTareas:FLSqlCursor)
...
\end */
function oficial_datosTarea()
{
	return true;
}

function oficial_borrarProcesosAsociados(tipoObjeto:String, idObjeto:String)
{
	var qryProcesos= new FLSqlQuery;
...
\end */
function oficial_calcularAsignacionTarea()
{
	var util= new FLUtil;
	var datos= [];
	var idAlias= util.sqlSelect("pr_tipostareapro", "idalias", "idtipotareapro = " + this.iface.curTarea_.valueBuffer("idtipotareapro"));
...
\end */
function oficial_condicionOK(idProceso:String, condicion:String)
{
// debug("condicion = " + condicion);
	var nodoProceso= this.iface.dameXMLProceso(idProceso);
	var eProceso= false;
	if (nodoProceso) {
	...
	var resultado= funcionVal(eProceso);
...
\end */
function oficial_condicionSecuenciaOK(idProceso:String, secuencia:String)
{
	return true;
}

function oficial_crearXMLProceso(curProceso:FLSqlCursor)
{
	var util= new FLUtil;

	var idTipoProceso= curProceso.valueBuffer("idtipoproceso");
	var idProceso= curProceso.valueBuffer("idproceso");
	var contenido= "<Proceso IdProceso='" + idProceso + "' IdTipoProceso='" + idTipoProceso + "'>";
	contenido += "</Proceso>";

	var xmlDocProceso= new FLDomDocument;
...
function oficial_dameXMLProceso(idProceso:String)
{
// debug("prod_dameXMLProceso " + idProceso);
	var util= new FLUtil;
	var xmlProceso:FLDomNode;
	var parametrosXML= util.sqlSelect("pr_procesos", "xmlparametros", "idproceso = " + idProceso);
...
\end */
function oficial_establecerAtributoProceso(idProceso:String, atributo:String, valor:String)
{
	var curProceso= new FLSqlCursor("pr_procesos");
	curProceso.select("idproceso = " + idProceso);
	if (!curProceso.first()) {
	...
	curProceso.setModeAccess(curProceso.Edit);
	curProceso.refreshBuffer();
	var xmlProceso= new FLDomDocument;
	if (!xmlProceso.setContent(curProceso.valueBuffer("xmlparametros"))) {
		return false;
	}
	var eProceso= xmlProceso.firstChild().toElement();
...
// function head_terminarTareaEsp(curTarea:FLSqlCursor)
// {
// 	var util= new FLUtil;
...
// 
// 	var codigoTT= util.sqlSelect("pr_tipostareapro", "codigott", "idtipotareapro = '" + curTarea.valueBuffer("idtipotareapro") + "'");
...
// }
// 
// function head_iniciarTareaEsp(curTarea:FLSqlCursor)
// {
// 	var util= new FLUtil;
// 	var resultado:Boolean
// 	var funcionVal;
...
// 	var contenido:String;
// 
// 	var codigoCT= util.sqlSelect("pr_tipostareapro", "codigoct", "idtipotareapro = '" + curTarea.valueBuffer("idtipotareapro") + "'");
...
function oficial_arrayAccion(contexto:String, accion:String)
{
	var aAccion= [];
	aAccion["usada"] = false;
...
\end */
function oficial_terminarTareaPorEstado(curTarea:FLSqlCursor)
{
	var util= new FLUtil;
	var idTarea= curTarea.valueBuffer("idtarea");
...
@param curTarea: Cursor de la tarea
\end */
function oficial_ponerTareaEnCursoPorEstado(curTarea:FLSqlCursor)
{
	var util= new FLUtil;
	var idTarea= curTarea.valueBuffer("idtarea");
	switch (curTarea.valueBuffer("estado")) {
...
@param curTarea: Cursor de la tarea
\end */
function oficial_ponerTareaPtePorEstado(curTarea:FLSqlCursor)
{
	var util= new FLUtil;
	var idTarea= curTarea.valueBuffer("idtarea");
	switch (curTarea.valueBuffer("estado")) {
...
\end */
function oficial_dormirTareaPorEstado(curTarea:FLSqlCursor, fechaActivacion:String)
{
	var util= new FLUtil;
	var idTarea= curTarea.valueBuffer("idtarea");
	switch (curTarea.valueBuffer("estado")) {
...
@param fechaActivacion: Fecha de activación automática de la tarea
\end */
function oficial_dormirTarea(curTarea:FLSqlCursor, fechaActivacion:String)
{
	var curTareaD= new FLSqlCursor("pr_tareas");
...
@param curTarea: Cursor de la tarea
\end */
function oficial_despertarTarea(curTarea:FLSqlCursor)
{
	var curTareaD= new FLSqlCursor("pr_tareas");
	curTareaD.setActivatedCommitActions(false);
	curTareaD.select("idtarea = '" + curTarea.valueBuffer("idtarea") + "'");
...
function oficial_calcularFechaActivacion(curTarea:FLSqlCursor)
{
	var util:FLUtil;
	var fA:String;
	var hoy= util.sqlSelect("empresa", "CURRENT_DATE", "1=1");
	switch (curTarea.valueBuffer("idtipotareapro")) {
		...
		default: {
			...
			dialogo.cancelButtonText = util.translate("scripts", "Cancelar");
			var dedFechaActivacion= new DateEdit;
...
function oficial_comprobarTareasInit()
{
	...
	var idUsuario= sys.nameUser();
	var texto= util.translate("scripts", "Hola %1").arg(idUsuario);
	texto += "\n";
	texto += "\n";
	var pendientes= parseInt(util.sqlSelect("pr_tareas", "COUNT(*)", "iduser = '" + idUsuario + "' AND estado = 'PTE'"));
	pendientes = (isNaN(pendientes) ? 0 : pendientes);
	
	var enCurso= parseInt(util.sqlSelect("pr_tareas", "COUNT(*)", "realizadapor = '" + idUsuario + "' AND estado = 'EN CURSO'"));
	...
	if (pendientes == 0 && enCurso == 0) {
		...
		var res= MessageBox.information(texto, MessageBox.Yes, MessageBox.No);
...
function oficial_globalInit()
{
	...
	var checkTareas= util.readSettingEntry("scripts/flcolaproc/checkTareas");
	if (checkTareas == "true") {
		this.iface.comprobarTareasInit();
	}
	this.iface.lanzarPreavisos();
}

function oficial_lanzarPreavisos()
{	
debug("oficial_lanzarPreavisos()");
	if (this.iface.timerPreavisos_) {
		killTimer(this.iface.timerPreavisos_);
	}
	var util = new FLUtil;
	var preavisar = util.sqlSelect("pr_config", "preavisartareas", "1 = 1");
debug("preavisar " + preavisar);
	if (!preavisar) {
		return;
	}
	var minutos = util.sqlSelect("pr_config", "minrevision", "1 = 1");
debug("minutos " + minutos);
	if (!minutos || isNaN(minutos)) {
		return;
	}
	sys.addDatabase("con_preavisos");
	this.iface.timerPreavisos_ = startTimer(minutos * 60000, this.iface.controlPreavisos);
}

function oficial_controlPreavisos()
{
	debug("oficial_controlPreavisos");
	var util = new FLUtil;
	var idUsuario = sys.nameUser();
	var minutos = util.sqlSelect("pr_config", "minantelacionaviso", "1 = 1");
	var ahora = new Date;
	var tiempo = ahora.getTime();
	tiempo += minutos * 60000;
	var desde = new Date(tiempo);
debug("Desde = " + desde.toString());
	var qryPorAvisar = new FLSqlQuery("", "con_preavisos");
	qryPorAvisar.setTablesList("pr_tareas");
	qryPorAvisar.setSelect("idtarea, descripcion, fechainicioprev, horainicioprev");
	qryPorAvisar.setFrom("pr_tareas");
	qryPorAvisar.setWhere("iduser = '" + idUsuario + "' AND estado = 'PTE' AND preaviso = true AND fechainicioprev = '" + desde.toString().left(10) + "' AND horainicioprev <= '" + desde.toString().right(8) + "' ORDER BY idtarea");
	qryPorAvisar.setForwardOnly(true);
debug(qryPorAvisar.sql());
	if (!qryPorAvisar.exec()) {
		return false;
	}
	var listaTareas = "";
	var listaMsg = "";
	var idTarea, fechaInicio, horaInicio;
	while (qryPorAvisar.next()) {
		idTarea = qryPorAvisar.value("idtarea");
		fechaInicio = qryPorAvisar.value("fechainicioprev");
		fechaInicio = util.dateAMDtoDMA(fechaInicio);
		horaInicio = qryPorAvisar.value("horainicioprev");
		horaInicio = horaInicio && horaInicio != "" ? horaInicio.toString().mid(11, 5): "";
		listaTareas += listaTareas != "" ? ", " : "";
		listaTareas += "'" + idTarea + "'";
		listaMsg = idTarea + ". " + fechaInicio + "-" + horaInicio + ": " + qryPorAvisar.value("descripcion") + "<br>";
	}
	if (listaTareas == "") {
		return;
	}
	var cl = "blue";
    var msgWarn = "<p><font color=\"" + cl + "\">" +
                  "Aviso de tareas:" +
                  "<br><br>" + listaMsg + 
                  "<br><br><em><a href=\"flcolaproc.quitarAvisoTareas\">Suprimir este aviso</a></em></font>";
    var scriptCalls = [];
    scriptCalls["flcolaproc.quitarAvisoTareas"] = listaTareas;
	try {
		sys.popupWarn(msgWarn, scriptCalls);
	} catch (e) {};
}

function quitarAvisoTareas(listaTareas)
{
	debug("quitarAvisoTareas");
	var util = new FLUtil;
	var curTareas = new FLSqlCursor("pr_tareas", "con_preavisos");
	curTareas.setActivatedCommitActions(false);
	curTareas.select("idtarea IN (" + listaTareas + ")");
	while (curTareas.next()) {
		curTareas.setModeAccess(curTareas.Edit);
		curTareas.refreshBuffer();
		curTareas.setValueBuffer("preaviso", false);
		if (!curTareas.commitBuffer()) {
			return false;
		}
	}
	MessageBox.information(util.translate("scripts", "Aviso suprimido"), MessageBox.Ok, MessageBox.NoButton);
}
